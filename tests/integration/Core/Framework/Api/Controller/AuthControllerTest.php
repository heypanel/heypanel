...
use HeyPanel\Core\Framework\Api\OAuth\Scope\UserVerifiedScope;
use HeyPanel\Core\Framework\Api\Util\AccessKeyHelper;
use HeyPanel\Core\Framework\Context;
use HeyPanel\Core\Framework\Test\TestCaseBase\AdminFunctionalTestBehaviour;
use HeyPanel\Core\Framework\Test\TestCaseHelper\TestUser;
use HeyPanel\Core\Framework\Uuid\Uuid;
use HeyPanel\Core\Test\TestDefaults;
...
class AuthControllerTest extends TestCase
{
    ...
    {
        $client = $this->getBrowser(false);
        $configuration = static::getContainer()->get('heypanel.jwt_config');
    ...
    public function testIntegrationAuth(): void
    {
         ...
         */
        $client->setServerParameter('HTTP_Authorization', \sprintf('Bearer %s', $accessToken));
        $client->request('GET', '/api/_action/access-key/intergration');
    ...
    public function testUnauthorizedWithPasswordGrantTypeWhenTokenExpired(): void
    {
        ...
        $admin = TestUser::createNewTestUser($connection, ['user:read']);
