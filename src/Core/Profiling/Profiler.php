...
namespace HeyPanel\Core\Profiling;

use HeyPanel\Core\Profiling\Integration\ProfilerInterface;
...
{
    /**
     * Profilers will be activated over the heypanel.yaml file
     *
     ...
     * @return TReturn
     */
    public static function trace(string $name, \Closure $closure, string $category = 'heypanel', array $tags = [])
    {
