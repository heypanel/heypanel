...
use HeyPanel\Core\Framework\Api\Controller\FallbackController;
...
class Kernel extends HttpKernel
{
     ...
     */
    final public const HEYADMIN_FALLBACK_VERSION = '6.7.9999999-dev';

    protected static ?Connection $connection = null;

    protected string $heypanelVersion;

    protected ?string $heypanelVersionRevision;
    ...
    public function __construct(
        ...
        $versionArray = VersionParser::parseHeyPanelVersion($version);
        $this->heypanelVersion = $versionArray['version'];
        $this->heypanelVersionRevision = $versionArray['revision'];
    ...
    public function registerBundles(): iterable
    {
        ...
        foreach ($bundles as $class => $envs) {
            if (isset($envs['all']) || isset($envs[$this->environment])) {
                /** @var HeyPanelBundle|Bundle $bundle */
                $bundle = new $class();
    ...
    protected function getKernelParameters(): array
    {
        ...
        return array_merge(
            ...
            [
                ...
                'kernel.heypanel_core_dir' => $coreDir,
    ...
    protected function getCacheHash(): string
    {
        ...
        return Hasher::hash([
            $this->cacheId,
            (string) $this->heypanelVersionRevision,
            $plugins,
        ]);
    }
...
PHP;
     ...
     */
    private function isBundleRegistered(Bundle|HeyPanelBundle $bundle, array $instantiatedBundleNames): bool
    {
