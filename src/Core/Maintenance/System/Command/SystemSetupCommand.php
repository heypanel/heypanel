...
class SystemSetupCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (\is_file($this->projectDir . '/symfony.lock')) {
            $io->warning('It looks like you have installed HeyPanel with Symfony Flex. You should use a .env.local file instead of creating a complete new one');
        }

        $io->title('HeyPanel setup process');
    ...
    private function getDsn(InputInterface $input, SymfonyStyle $io): array
    {
        ...
        $dbName = $io->ask('Database name', 'heypanel', $emptyValidation);
