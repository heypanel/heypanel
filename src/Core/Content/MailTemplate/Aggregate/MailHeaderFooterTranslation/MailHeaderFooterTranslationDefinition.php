...
namespace HeyPanel\Core\Content\MailTemplate\Aggregate\MailHeaderFooterTranslation;

use HeyPanel\Core\Content\MailTemplate\Aggregate\MailHeaderFooter\MailHeaderFooterDefinition;
