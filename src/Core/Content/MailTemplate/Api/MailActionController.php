...
namespace HeyPanel\Core\Content\MailTemplate\Api;

use HeyPanel\Core\Content\Mail\Service\AbstractMailService;
use HeyPanel\Core\Content\Mail\Service\MailAttachmentsConfig;
use HeyPanel\Core\Content\MailTemplate\MailTemplateEntity;
use HeyPanel\Core\Content\MailTemplate\MailTemplateException;
