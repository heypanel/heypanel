...
use HeyPanel\Core\Content\Sitemap\Extension\SitemapFileExtension;
...
class SitemapFileRoute
{
    ...
    #[Route(path: '/client-api/sitemap/{filePath}', name: 'client-api.sitemap.file', requirements: ['filePath' => '.+\.xml\.gz'], methods: ['GET', 'POST'])]
