...
use HeyPanel\Core\Content\ImportExport\Exception\FileNotFoundException;
use HeyPanel\Core\Content\ImportExport\Exception\InvalidFileAccessTokenException;
use HeyPanel\Core\Content\ImportExport\Exception\InvalidIdentifierException;
use HeyPanel\Core\Content\ImportExport\Exception\ProcessingException;
use HeyPanel\Core\Content\ImportExport\Exception\ProfileNotFoundException;
use HeyPanel\Core\Content\ImportExport\Exception\RequiredByUserException;
...
class ImportExportException extends HttpException
{
    ...
    public static function invalidFileAccessToken(): HeyPanelHttpException
    {
        return new InvalidFileAccessTokenException();
    }

    public static function fileNotFound(string $fileId): HeyPanelHttpException
    {
        return new FileNotFoundException($fileId);
    }

    public static function processingError(string $message): HeyPanelHttpException
    {
        return new ProcessingException($message);
    }

    public static function requiredByUser(string $column): HeyPanelHttpException
    {
        return new RequiredByUserException($column);
    }

    public static function invalidIdentifier(string $id): HeyPanelHttpException
    {
        return new InvalidIdentifierException($id);
    }

    public static function decorationPattern(string $class): HeyPanelHttpException
    {
        return new DecorationPatternException($class);
    }

    public static function profileNotFound(string $profileId): HeyPanelHttpException
    {
