...
namespace HeyPanel\Core\Content\Media\Upload;

use HeyPanel\Core\Content\Media\Event\MediaUploadedEvent;
use HeyPanel\Core\Content\Media\File\FileFetcher;
...
readonly class MediaUploadService
{
    ...
    /**
     * Link the external URL into a new Media object. HeyPanel does not store any file
     */
