...
use HeyPanel\Core\Content\Media\Message\UpdateThumbnailsMessage;
...
use HeyPanel\Core\Framework\DataAbstractionLayer\Dbal\Common\RepositoryIterator;
...
class GenerateThumbnailsCommand extends Command
{
    ...
    {
        $this->io = new HeyPanelStyle($input, $output);
