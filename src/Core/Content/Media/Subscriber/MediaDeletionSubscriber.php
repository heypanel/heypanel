...
use HeyPanel\Core\Content\Media\Event\MediaThumbnailDeletedEvent;
use HeyPanel\Core\Content\Media\MediaCollection;
use HeyPanel\Core\Content\Media\MediaDefinition;
use HeyPanel\Core\Content\Media\Message\DeleteFileHandler;
use HeyPanel\Core\Content\Media\Message\DeleteFileMessage;
