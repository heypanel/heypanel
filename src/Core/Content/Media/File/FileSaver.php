...
use HeyPanel\Core\Content\Media\Aggregate\MediaThumbnail\MediaThumbnailEntity;
use HeyPanel\Core\Content\Media\Core\Application\AbstractMediaPathStrategy;
use HeyPanel\Core\Content\Media\Core\Event\UpdateMediaPathEvent;
use HeyPanel\Core\Content\Media\Event\MediaFileExtensionWhitelistEvent;
use HeyPanel\Core\Content\Media\Event\MediaPathChangedEvent;
use HeyPanel\Core\Content\Media\Infrastructure\Path\SqlMediaLocationBuilder;
...
use HeyPanel\Core\Content\Media\Message\GenerateThumbnailsMessage;
use HeyPanel\Core\Content\Media\Metadata\MetadataLoader;
use HeyPanel\Core\Content\Media\Thumbnail\ThumbnailService;
use HeyPanel\Core\Content\Media\TypeDetector\TypeDetector;
