...
class NavigationRoute extends AbstractNavigationRoute
{
     ...
     * @param string[] $ids
     */
    private function loadCategories(array $ids, ChannelContext $context, Criteria $criteria): CategoryCollection
    {
        $criteria->setIds($ids);
    ...
    private function loadLevels(string $rootId, int $rootLevel, ChannelContext $context, Criteria $criteria, int $depth = 2): CategoryCollection
    {
        $criteria->addFilter(
     ...
     * @param array<string, CategoryMetaInformation> $metaInfo
     */
    private function loadChildren(string $activeId, ChannelContext $context, string $rootId, array $metaInfo, CategoryCollection $categories, Criteria $criteria): CategoryCollection
    {
        $active = $this->getMetaInfoById($activeId, $metaInfo);
