...
use HeyPanel\Core\Content\Cms\Exception\DuplicateCriteriaKeyException;
...
class CmsException extends HttpException
{
    ...
    public static function overallDefaultSystemConfigDeletion(string $cmsPageId): self
    {
        return new self(
            ...
            'The cms page with id "{{ cmsPageId }}" is assigned as a default to all channels and therefore can not be deleted.',
            ['cmsPageId' => $cmsPageId]
        );
    }
