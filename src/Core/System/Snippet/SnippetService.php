...
use HeyPanel\Core\System\Snippet\Extension\FrontendSnippetsExtension;
use HeyPanel\Core\System\Snippet\Files\AbstractSnippetFile;
use HeyPanel\Core\System\Snippet\Files\SnippetFileCollection;
use HeyPanel\Core\System\Snippet\Filter\SnippetFilterFactory;
...
class SnippetService
{
     ...
     */
    public function getFrontendSnippets(MessageCatalogueInterface $catalog, string $snippetSetId, ?string $fallbackLocale = null, ?string $salesChannelId = null): array
    {
