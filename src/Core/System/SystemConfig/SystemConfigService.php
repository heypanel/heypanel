...
use HeyPanel\Core\Framework\Util\XmlReader;
...
use HeyPanel\Core\System\SystemConfig\Event\BeforeSystemConfigMultipleChangedEvent;
use HeyPanel\Core\System\SystemConfig\Event\SystemConfigChangedEvent;
use HeyPanel\Core\System\SystemConfig\Event\SystemConfigDomainLoadedEvent;
use HeyPanel\Core\System\SystemConfig\Event\SystemConfigMultipleChangedEvent;
use HeyPanel\Core\System\SystemConfig\Exception\BundleConfigNotFoundException;
use HeyPanel\Core\System\SystemConfig\Exception\InvalidDomainException;
use HeyPanel\Core\System\SystemConfig\Exception\InvalidKeyException;
use HeyPanel\Core\System\SystemConfig\Exception\InvalidSettingValueException;
...
class SystemConfigService implements ResetInterface
{
    ...
    {
        $this->dispatcher->dispatch(new AddCacheTagEvent('system.config-' . $channelId));
