...
namespace HeyPanel\Core\System\SystemConfig\Validation;
...
class SystemConfigValidator
{
    ...
    public function validate(array $inputData, Context $context): void
    {
        ...
        foreach ($inputData as $saleChannelId => $inputValues) {
            // If channel is defined, nulls are valid values, as they are used to remove custom values in child configuration
