...
namespace HeyPanel\Core\System\User\Api;

use HeyPanel\Core\Framework\Context;
use HeyPanel\Core\Framework\RateLimiter\RateLimiter;
use HeyPanel\Core\System\User\Recovery\UserRecoveryService;
...
class UserRecoveryController extends AbstractController
{
    ...
    #[Route(path: '/api/_action/user/user-recovery', name: 'api.action.user.user-recovery', defaults: ['auth_required' => false], methods: ['POST'])]
    ...
    #[Route(path: '/api/_action/user/user-recovery/hash', name: 'api.action.user.user-recovery.hash', defaults: ['auth_required' => false], methods: ['GET'])]
    ...
    #[Route(path: '/api/_action/user/user-recovery/password', name: 'api.action.user.user-recovery.password', defaults: ['auth_required' => false], methods: ['PATCH'])]
