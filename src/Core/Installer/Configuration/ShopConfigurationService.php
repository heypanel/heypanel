...
use HeyPanel\Core\Framework\DataAbstractionLayer\Util\StatementHelper;
...
class ShopConfigurationService
{
    ...
    private function performUpdate(array $shop, Connection $connection): void
    {
        ...
        $shopConfigurator = new WebsiteConfigurator($connection, $this->eventDispatcher);
...
SQL;
    ...
    /**
     * get the id of the channel via the channel type id
     */
    ...
    private function addAdditionalCurrenciesToChannel(array $shop, string $channelId, Connection $connection): void
    {
        ...
        // set the default currency of the headless channel
        ...
        // remove all currencies from the headless channel, except the default currency
        $connection->executeStatement(
        ...
        // set the currencies of the headless channel to the ones from the default channel
    ...
    {
        // change default currency for dummy channel domain to the default currency to avoid foreign key constraints
        $connection->executeStatement(
