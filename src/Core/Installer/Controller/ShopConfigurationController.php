...
use HeyPanel\Core\Installer\Configuration\AdminConfigurationService;
use HeyPanel\Core\Installer\Configuration\EnvConfigWriter;
use HeyPanel\Core\Installer\Configuration\ShopConfigurationService;
...
class ShopConfigurationController extends InstallerController
{
    ...
    private function getCountryIsos(Connection $connection, string $currentLocale): array
    {
        ...
        $countryIsos = array_map(fn ($country) => [
            ...
            'translated' => $this->translator->trans('heypanel.installer.select_country_' . mb_strtolower((string) $country['iso3'])),
        ], $countries);
