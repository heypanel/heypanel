...
namespace HeyPanel\Core\Framework\DataAbstractionLayer\Doctrine;

use Doctrine\DBAL\Connection;
use Doctrine\DBAL\Exception\RetryableException;
use Doctrine\DBAL\Statement;
use HeyPanel\Core\Framework\DataAbstractionLayer\Util\StatementHelper;
use HeyPanel\Core\Framework\Telemetry\Metrics\MeterProvider;
    ...
    private static function retry(?Connection $connection, \Closure $closure, int $counter)
    {
        ...
        try {
            ...
            if ($connection && $connection->getTransactionNestingLevel() > 0) {
                // If this closure was executed inside a transaction, do not retry. Recustomer that the whole (outermost)
