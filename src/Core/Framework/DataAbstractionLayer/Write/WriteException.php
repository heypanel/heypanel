...
use HeyPanel\Core\Framework\Api\EventListener\ErrorResponseFactory;
use HeyPanel\Core\Framework\HeyPanelHttpException;
use Symfony\Component\HttpFoundation\Response;

class WriteException extends HeyPanelHttpException
{
    ...
    public function getErrors(bool $withTrace = false): \Generator
    {
        foreach ($this->getExceptions() as $innerException) {
            if ($innerException instanceof HeyPanelHttpException) {
