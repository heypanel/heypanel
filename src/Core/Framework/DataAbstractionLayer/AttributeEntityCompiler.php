...
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\AllowEmptyString as AllowEmptyStringAttr;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\AllowHtml as AllowHtmlAttr;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\AutoIncrement;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\CustomFields as CustomFieldsAttr;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\Entity;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\Field;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\FieldType;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\ForeignKey;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\Inherited;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\ManyToMany;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\ManyToOne;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\OnDelete;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\OneToMany;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\OneToOne;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\PrimaryKey as PrimaryKeyAttr;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\Protection;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\ReferenceVersion;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\Required as RequiredAttr;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\Serialized;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\State;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\Translations;
use HeyPanel\Core\Framework\DataAbstractionLayer\Attribute\Version;
use HeyPanel\Core\Framework\DataAbstractionLayer\Entity as EntityStruct;
...
use HeyPanel\Core\Framework\DataAbstractionLayer\Field\Field as DalField;
...
use HeyPanel\Core\Framework\DataAbstractionLayer\Field\Flag\AsArray;
    ...
    private function getFlags(Field $field, \ReflectionProperty $property): array
    {
        ...
        if ($field->api !== false) {
            ...
            if (\is_array($field->api)) {
                ...
                if (isset($field->api['client-api']) && $field->api['client-api'] === true) {
