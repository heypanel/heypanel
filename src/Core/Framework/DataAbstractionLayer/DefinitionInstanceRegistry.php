...
use HeyPanel\Core\Framework\DataAbstractionLayer\Dbal\FieldAccessorBuilder\FieldAccessorBuilderInterface;
use HeyPanel\Core\Framework\DataAbstractionLayer\Dbal\FieldResolver\AbstractFieldResolver;
...
class DefinitionInstanceRegistry
{
    ...
    /**
     * @param array<string, string|class-string<EntityDefinition>> $definitions array of $entityName => $definitionServiceId, e.g. 'question' => '\HeyPanel\Core\Content\Question\PostDefinition'
     * @param array<string, string> $repositoryMap array of $entityName => $repositoryServiceId, e.g. 'question' => 'question.repository'
     *
     *@internal
     */
