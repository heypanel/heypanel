...
use HeyPanel\Core\Framework\DataAbstractionLayer\MigrationFileRenderer;
use HeyPanel\Core\Framework\DataAbstractionLayer\MigrationQueryGenerator;
...
class CreateMigrationCommand extends Command
{
    ...
    private function getNamespace(InputInterface $input): string
    {
        ...
        if (!$bundleName) {
            return 'HeyPanel\\Core\\Migration\\' . $this->getNamespaceFolder($input);
        }
    ...
    private function getNamespaceFolder(InputInterface $input): string
    {
        ...
        [$_, $major] = explode('.', $this->heypanelVersion);
