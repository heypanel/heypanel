...
use HeyPanel\Core\Framework\Api\ApiDefinition\Generator\OpenApi\OpenApiDefinitionSchemaBuilder;
use HeyPanel\Core\Framework\Api\ApiDefinition\Generator\OpenApi\OpenApiSchemaBuilder;
 ...
 */
class ClientApiGenerator implements ApiDefinitionGeneratorInterface
{
    ...
    public function __construct(
        ...
        $this->schemaPath = $bundles['Framework']['path'] . '/Api/ApiDefinition/Generator/Schema/ClientApi';
    }

    public function supports(string $format, string $api): bool
    {
        return $format === self::FORMAT && $api === DefinitionService::CLIENT_API;
    }
    ...
    public function generate(array $definitions, string $api, string $apiType, ?string $bundleName): array
    {
        ...
        $forChannel = $api === DefinitionService::CLIENT_API;
    ...
    {
        $openApi->info->description = 'This endpoint reference contains an overview of all endpoints comprising the HeyPanel Store API';
