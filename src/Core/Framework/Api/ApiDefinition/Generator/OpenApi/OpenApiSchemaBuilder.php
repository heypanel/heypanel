...
namespace HeyPanel\Core\Framework\Api\ApiDefinition\Generator\OpenApi;
...
class OpenApiSchemaBuilder
{
    ...
    {
        return new Info([
            'title' => 'HeyPanel ' . self::API[$api]['name'],
            'version' => $version,
            'license' => [
                'name' => 'MIT',
                'url' => 'https://github.com/heypanel/heypanel/blob/trunk/LICENSE',
            ],
            'description' => <<<'EOF'
This endpoint reference contains an overview of all endpoints comprising the HeyPanel Admin API.
...
EOF,
        ...
        $defaults = [
            'success' => new Schema([
                ...
                'properties' => [
                    ...
                    'links' => [
                        'description' => 'Link customers related to the primary data.',
                        'allOf' => [
            ...
            'relationshipLinks' => new Schema([
                ...
                'description' => 'A resource object **MAY** contain references to other resource objects ("relationships"). Relationships may be to-one or to-many. Relationships can be specified by including a customer in a resource\'s links object.',
                'type' => 'object',
                'additionalProperties' => true,
                'properties' => [
                    new Property([
                        ...
                        'allOf' => [
                            new Schema([
                                'description' => 'A `self` customer, whose value is a URL for the relationship itself (a "relationship URL"). This URL allows the client to directly manipulate the relationship. For example, it would allow a client to remove an `author` from an `article` without deleting the people resource itself.',
                                'type' => 'array',
                                'items' => [
                                    'type' => 'object',
                                ],
            ...
            'attributes' => new Schema([
                'schema' => 'attributes',
                'description' => 'Customers of the attributes object ("attributes") represent information about the resource object in which it\'s defined.',
                'type' => 'object',
                'additionalProperties' => true,
            ]),
            'relationships' => new Schema([
                'schema' => 'relationships',
                'description' => 'Customers of the relationships object ("relationships") represent references from the resource object in which it\'s defined to other resource objects.',
                'type' => 'object',
                'anyOf' => [
                    ['required' => ['data']],
                    ['required' => ['meta']],
                    ...
                    [
                        ...
                        'properties' => [
                            ...
                            'data' => [
                                'description' => 'Customer, whose value represents "resource linkage".',
                                'oneOf' => [
            ...
            'relationshipToOne' => new Schema([
                ...
                'allOf' => [
                    new Schema([
                        'description' => 'References to other resource objects in a to-one ("relationship"). Relationships can be specified by including a customer in a resource\'s links object.',
                    ]),
                    new Schema([
            ...
            'relationshipToMany' => new Schema([
                ...
                'description' => 'An array of objects each containing \"type\" and \"id\" customers for to-many relationships.',
                'type' => 'array',
                'items' => [
                    '$ref' => '#/components/schemas/linkage',
                ],
            ...
            'linkage' => new Schema([
                'schema' => 'linkage',
                'description' => 'The "type" and "id" to non-empty customers.',
                'type' => 'object',
                'required' => ['type', 'id'],
                'properties' => [
                    'type' => ['type' => 'string'],
    ...
    private function createSecurityScheme(string $api): array
    {
        if (self::API[$api]['apiKey']) {
            return [
                'Channel Access Key' => new SecurityScheme([
                    'securityScheme' => 'ApiKey',
                    'type' => 'apiKey',
                    'in' => 'header',
                    'name' => PlatformRequest::HEADER_ACCESS_KEY,
                    'description' => 'Identifies the channel you want to access the API through',
                ]),
