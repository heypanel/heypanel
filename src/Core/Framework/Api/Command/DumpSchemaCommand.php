...
namespace HeyPanel\Core\Framework\Api\Command;

use HeyPanel\Core\Framework\Api\ApiDefinition\DefinitionService;
use HeyPanel\Core\Framework\Api\ApiDefinition\Generator\CachedEntitySchemaGenerator;
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        switch ($formatType) {
            case 'simple':
                ...
                break;
            case 'openapi3':
                $api = $input->getOption('client-api') ? DefinitionService::STORE_API : DefinitionService::API;
