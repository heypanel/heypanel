 ...
 *
 * @phpstan-import-type ErrorData from HeyPanelHttpException as HeyPanelExceptionData
 */
class ErrorResponseFactory
{
    ...
    /**
     * @return array<DefaultExceptionData|HeyPanelExceptionData>
     */
    public function getErrorsFromException(\Throwable $exception, bool $debug = false): array
    {
        if ($exception instanceof HeyPanelHttpException) {
            $errors = [];
    ...
    private function getStatusCodeFromException(\Throwable $exception): int
    {
        ...
        if ($exception instanceof HeyPanelHttpException || $exception instanceof HttpException) {
