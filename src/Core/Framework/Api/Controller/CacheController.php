...
class CacheController extends AbstractController
{
    ...
    public function info(): JsonResponse
    {
        return new JsonResponse([
            ...
            'httpCache' => $this->container->get('parameter_bag')->has('heypanel.http.cache.enabled') && $this->getParameter('heypanel.http.cache.enabled'),
    ...
    #[Route(path: '/api/_action/cache-delayed', name: 'api.action.cache.delete-delayed', defaults: ['_acl' => ['system:clear:cache']], methods: ['DELETE'])]
    ...
    private function getUsedCache(AdapterInterface $adapter): string
    {
        ...
        return str_replace('Adapter', '', end($parts));
    }
}
