...
use HeyPanel\Core\Framework\Api\Acl\AclCriteriaValidator;
...
use HeyPanel\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtection;
use HeyPanel\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtectionValidator;
...
use HeyPanel\Core\Framework\DataAbstractionLayer\Write\CloneBehavior;
...
class ApiController extends AbstractController
{
    ...
    #[Route(path: '/api/_action/clone/{entity}/{id}', name: 'api.clone', requirements: ['version' => '\d+', 'entity' => '[0-9a-zA-Z-]+', 'id' => '[0-9a-f]{32}'], methods: ['POST'])]
    ...
    #[Route(path: '/api/_action/version/{entity}/{id}', name: 'api.createVersion', requirements: ['version' => '\d+', 'entity' => '[0-9a-zA-Z-]+', 'id' => '[0-9a-f]{32}'], methods: ['POST'])]
    ...
    #[Route(path: '/api/_action/version/merge/{entity}/{versionId}', name: 'api.mergeVersion', requirements: ['version' => '\d+', 'entity' => '[0-9a-zA-Z-]+', 'versionId' => '[0-9a-f]{32}'], methods: ['POST'])]
    ...
    #[Route(path: '/api/_action/version/{versionId}/{entity}/{entityId}', name: 'api.deleteVersion', requirements: ['version' => '\d+', 'entity' => '[0-9a-zA-Z-]+', 'id' => '[0-9a-f]{32}'], methods: ['POST'])]
    ...
    private function resolveSearch(Request $request, Context $context, string $entityName, string $path): array
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \HeyPanel\Core\Content\Product\Definition\ProductPriceDefinition
             */
             ...
             * $definition:     \HeyPanel\Core\Content\Product\Aggregate\ProductManufacturer\ProductManufacturerDefinition
             */
             ...
             * $definition:     \HeyPanel\Core\Checkout\Order\Aggregate\OrderCustomer\OrderCustomerDefinition
             */
    ...
    private function getDefinitionOfPath(string $entityName, string $path, Context $context): EntityDefinition
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \HeyPanel\Core\Content\Category\CategoryDefinition
             */
