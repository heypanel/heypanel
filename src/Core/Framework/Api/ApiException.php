...
namespace HeyPanel\Core\Framework\Api;
...
use HeyPanel\Core\Framework\Api\Exception\ExpectationFailedException;
...
use HeyPanel\Core\Framework\Api\Exception\InvalidVersionNameException;
use HeyPanel\Core\Framework\Api\Exception\LiveVersionDeleteException;
use HeyPanel\Core\Framework\Api\Exception\MissingPrivilegeException;
use HeyPanel\Core\Framework\Api\Exception\NoEntityClonedException;
use HeyPanel\Core\Framework\Api\Exception\ResourceNotFoundException;
use HeyPanel\Core\Framework\DataAbstractionLayer\Exception\DefinitionNotFoundException;
use HeyPanel\Core\Framework\DataAbstractionLayer\Exception\MissingReverseAssociation;
...
class ApiException extends HttpException
{
     ...
     */
    public static function missingPrivileges(array $permissions): HeyPanelHttpException
    {
        return new MissingPrivilegeException($permissions);
    }

    public static function missingReverseAssociation(string $entity, string $parentEntity): HeyPanelHttpException
    {
    ...
    public static function noEntityCloned(string $entity, string $id): HeyPanelHttpException
    {
     ...
     * @param string[] $fails
     */
    public static function expectationFailed(array $fails): HeyPanelHttpException
    {
        return new ExpectationFailedException($fails);
    }

    public static function invalidSyncOperation(string $message): HeyPanelHttpException
    {
    ...
    public static function invalidVersionName(): HeyPanelHttpException
    {
        return new InvalidVersionNameException();
    }

    public static function deleteLiveVersion(): HeyPanelHttpException
    {
     ...
     */
    public static function resourceNotFound(string $entity, array $payload): HeyPanelHttpException
    {
    ...
    public static function channelInMaintenanceMode(): self
    {
        return new self(
            ...
            'The channel is in maintenance mode.',
        );
    }
