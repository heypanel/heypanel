...
use HeyPanel\Core\Framework\Plugin\Exception\KernelPluginLoaderException;
use HeyPanel\Core\Framework\Plugin\Exception\PluginBaseClassNotFoundException;
use HeyPanel\Core\Framework\Plugin\Exception\PluginComposerJsonInvalidException;
use HeyPanel\Core\Framework\Plugin\Exception\PluginComposerRemoveException;
use HeyPanel\Core\Framework\Plugin\Exception\PluginComposerRequireException;
...
class PluginException extends HttpException
{
    ...
    public static function cannotDeleteHeyPanelMigrations(): self
    {
        return new self(
            Response::HTTP_INTERNAL_SERVER_ERROR,
            self::CANNOT_DELETE_SHOPWARE_MIGRATIONS,
            'Deleting HeyPanel migrations is not allowed'
        );
    }
