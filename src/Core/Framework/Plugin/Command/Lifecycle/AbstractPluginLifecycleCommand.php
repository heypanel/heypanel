...
namespace HeyPanel\Core\Framework\Plugin\Command\Lifecycle;
...
abstract class AbstractPluginLifecycleCommand extends Command
{
    ...
    protected function prepareExecution(
        ...
        $io->title('HeyPanel Plugin Lifecycle Service');
    ...
    protected function handleClearCacheOption(InputInterface $input, HeyPanelStyle $io, string $action): void
    {
