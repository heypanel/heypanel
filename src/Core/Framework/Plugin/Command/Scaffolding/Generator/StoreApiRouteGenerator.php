...
class StoreApiRouteGenerator implements ScaffoldingGenerator
{
    ...
    public const OPTION_NAME = 'create-client-api-route';
    private const OPTION_DESCRIPTION = 'Create an example client-api route';
    private const CLI_QUESTION = 'Do you want to create an example client-api route?';
    ...
    private function createAbstractStoreApiRoute(PluginScaffoldConfiguration $configuration): Stub
    {
        return Stub::template(
            ...
            self::STUB_DIRECTORY . '/client-api-abstract-route.stub',
            [
    ...
    private function createStoreApiRoute(PluginScaffoldConfiguration $configuration): Stub
    {
        return Stub::template(
            ...
            self::STUB_DIRECTORY . '/client-api-route.stub',
            [
                'namespace' => $configuration->namespace,
            ]
        );
    ...
    private function createStoreApiRouteResponse(PluginScaffoldConfiguration $configuration): Stub
    {
        return Stub::template(
            ...
            self::STUB_DIRECTORY . '/client-api-response.stub',
            [
                'namespace' => $configuration->namespace,
            ]
        );
