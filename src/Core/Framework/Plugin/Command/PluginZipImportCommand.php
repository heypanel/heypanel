...
use HeyPanel\Core\Framework\Plugin\Exception\NoPluginFoundInZipException;
...
class PluginZipImportCommand extends Command
{
    ...
    {
        $this->addArgument('zip-file', InputArgument::REQUIRED, 'Zip file that contains a heypanel platform plugin.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('HeyPanel Plugin Zip Import');
