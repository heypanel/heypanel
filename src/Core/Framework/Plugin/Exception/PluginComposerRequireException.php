...
/**
 * @deprecated tag:v6.8.0 - reason:remove-exception - Will be removed. Use \HeyPanel\Core\Framework\Plugin\PluginException::pluginComposerRequire instead
 */
class PluginComposerRequireException extends HeyPanelHttpException
{
