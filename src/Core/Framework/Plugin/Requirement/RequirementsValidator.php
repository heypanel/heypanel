...
use HeyPanel\Core\Framework\Plugin\Requirement\Exception\ComposerNameMissingException;
use HeyPanel\Core\Framework\Plugin\Requirement\Exception\ConflictingPackageException;
use HeyPanel\Core\Framework\Plugin\Requirement\Exception\MissingRequirementException;
use HeyPanel\Core\Framework\Plugin\Requirement\Exception\RequirementStackException;
use HeyPanel\Core\Framework\Plugin\Requirement\Exception\VersionMismatchException;
...
class RequirementsValidator
{
    ...
    private Composer $heypanelProjectComposer;
    ...
    public function validateRequirements(PluginEntity $plugin, Context $context, string $method): void
    {
        ...
        $this->heypanelProjectComposer = $this->getComposer($this->projectDir);
    ...
    private function checkComposerDependencies(
        ...
        foreach ($packages as $package) {
            // Ignore HeyPanel plugins. They are checked separately in `validateInstalledPlugins`
    ...
    {
        $packages = $this->heypanelProjectComposer->getRepositoryManager()->getLocalRepository()->getPackages();
