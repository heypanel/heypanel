...
use HeyPanel\Core\Framework\Feature\FeatureException;
use HeyPanel\Core\Framework\Script\Debugging\ScriptTraces;
...
class Feature
{
    ...
    public static function triggerDeprecationOrThrow(string $majorFlag, string $message): void
    {
        ...
        trigger_deprecation('heypanel/core', '', $message);
    }
