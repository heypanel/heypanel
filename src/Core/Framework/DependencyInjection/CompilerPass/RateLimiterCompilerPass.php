...
use HeyPanel\Core\Framework\RateLimiter\RateLimiterFactory;
...
class RateLimiterCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $rateLimiterConfig = $container->getParameter('heypanel.api.rate_limiter');
        ...
        $container->setDefinition('heypanel.rate_limiter', $rateLimiter);
    }
