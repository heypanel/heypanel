...
namespace HeyPanel\Core\Framework\Adapter\Translation;
...
class Translator extends AbstractTranslator
{
    ...
    public function getCatalogue(?string $locale = null): MessageCatalogueInterface
    {
        ...
        if ($this->isHeyPanelLocaleCatalogue($catalog) && !$this->isFallbackLocaleCatalogue($catalog, $localization)) {
    ...
    /**
     * HeyPanel uses dashes in all locales
     ...
     */
    private function isHeyPanelLocaleCatalogue(MessageCatalogueInterface $catalog): bool
    {
