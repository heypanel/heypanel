...
class TwigEnvironment extends Environment
{
    ...
    public function compile(Node $node): string
    {
        ...
        $replaces = [
            'CoreExtension::getAttribute(' => '\HeyPanel\Core\Framework\Adapter\Twig\SwTwigFunction::getAttribute(',
            'twig_escape_filter(' => '\HeyPanel\Core\Framework\Adapter\Twig\SwTwigFunction::escapeFilter(',
        ];
