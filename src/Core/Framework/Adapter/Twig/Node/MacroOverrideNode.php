...
class MacroOverrideNode extends MacroNode
{
    public function compile(Compiler $compiler): void
    {
        ...
        $compiler
            ...
            ->write("if (\HeyPanel\Core\Framework\Adapter\Twig\SwTwigFunction::\$macroResult !== null) {\n")
            ->write('$result = \HeyPanel\Core\Framework\Adapter\Twig\SwTwigFunction::$macroResult;' . "\n")
            ->write('\HeyPanel\Core\Framework\Adapter\Twig\SwTwigFunction::$macroResult = null;' . "\n")
            ->write("}\n")
            ->write("return \$result;\n")
