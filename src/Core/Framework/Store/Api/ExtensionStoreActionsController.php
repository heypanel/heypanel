...
use HeyPanel\Core\Framework\Store\Services\ExtensionDownloader;
    ...
    public function uploadExtensions(Request $request, Context $context): Response
    {
        ...
        if (!$file) {
            if (!Feature::isActive('v6.8.0.0')) {
                ...
                throw RoutingException::missingRequestParameter('file'); // @phpstan-ignore heypanel.domainException
            }
