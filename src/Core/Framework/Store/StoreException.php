...
namespace HeyPanel\Core\Framework\Store;

use GuzzleHttp\Exception\ClientException;
use HeyPanel\Core\Framework\HttpException;
use HeyPanel\Core\Framework\Store\Exception\ClientApiException;
use HeyPanel\Core\Framework\Store\Exception\ExtensionNotFoundException;
use HeyPanel\Core\Framework\Store\Exception\ExtensionUpdateRequiresConsentAffirmationException;
...
class StoreException extends HttpException
{
    ...
    public static function extensionThemeStillInUse(string $extensionId): self
    {
        return new self(
            ...
            'The extension with id "{{ extensionId }}" can not be removed because its theme is still assigned to a channel.',
    ...
    {
        return new ClientApiException($exception);
    }
