...
use HeyPanel\Core\Framework\Store\Authentication\AbstractStoreRequestOptionsProvider;
use HeyPanel\Core\Framework\Store\Exception\StoreTokenMissingException;
...
use HeyPanel\Core\Framework\Store\Struct\LicenseStruct;
...
use HeyPanel\Core\Framework\Store\Struct\StoreActionStruct;
use HeyPanel\Core\Framework\Store\Struct\StoreLicenseViolationStruct;
use HeyPanel\Core\Framework\Store\Struct\StoreLicenseViolationTypeStruct;
use HeyPanel\Core\Framework\Store\Struct\StoreUpdateStruct;
...
class StoreClient
{
    public const EXTENSION_LICENSE_IS_ALREADY_CANCELLED = 'HeyPanelPlatformException-61';
    ...
    public function loginWithHeyPanelId(string $heypanelId, string $password, Context $context): void
    {
        ...
        $response = $this->client->request(
            ...
            [
                ...
                'json' => [
                    'heypanelId' => $heypanelId,
                    'password' => $password,
                    'heypanelUserId' => $userId,
                ],
            ]
        );
    ...
    public function getPluginCompatibilities(Context $context, string $futureVersion, PluginCollection $pluginCollection): array
    {
        ...
        $response = $this->client->request(
            ...
            [
                ...
                'headers' => $this->getHeaders($context),
                'json' => [
                    'futureHeyPanelVersion' => $futureVersion,
                    'plugins' => $pluginArray,
                ],
            ]
        );
    ...
    public function isShopUpgradeable(): bool
    {
        $response = $this->client->request(
            ...
            [
                'query' => [
                    'language' => 'en_GB',
                    'heypanelVersion' => $this->getHeyPanelVersion(),
                ],
            ]
        );
    ...
    protected function getHeyPanelVersion(): string
    {
        return $this->instanceService->getHeyPanelVersion();
    }
