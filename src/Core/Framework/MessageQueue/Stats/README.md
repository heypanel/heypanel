...
This feature provides statistics about processed messages in the HeyPanel message queue system. It tracks message processing metrics and provides insights into message queue performance.
...
```json
{
    ...
    "messageTypeStats": [
        {
            "extensions": [],
            "type": "HeyPanel\\Core\\Framework\\Adapter\\Cache\\InvalidateCacheTask",
            "count": 1
        },
        {
            "extensions": [],
            "type": "HeyPanel\\Elasticsearch\\Framework\\Indexing\\CreateAliasTask",
            "count": 1
        },
        {
            "extensions": [],
            "type": "HeyPanel\\Core\\Content\\ProductExport\\ScheduledTask\\ProductExportGenerateTask",
            "count": 4
        }
    ]
}
...
The message queue statistics can be configured in your `config/packages/heypanel.yaml` file:
