...
namespace HeyPanel\Core\Framework\Migration\Command;

use HeyPanel\Core\Framework\Adapter\Console\HeyPanelStyle;
use HeyPanel\Core\Framework\Migration\Exception\UnknownMigrationSourceException;
...
class MigrationCommand extends Command
{
    ...
    public function __construct(
        ...
        protected readonly string $heypanelVersion
    ) {
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($total > 0) {
            $this->cache->clear();
            $this->io->writeln('cleared the heypanel cache');
        }
    ...
    {
        if ($identifier === 'core') {
            return $this->loader->collectAllForVersion($this->heypanelVersion);
        }
