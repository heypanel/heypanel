...
namespace HeyPanel\Core\Framework\Test\TestCaseHelper;
...
class TestUser
{
    ...
    {
        return new TestUser('heypanel', 'admin', Uuid::randomHex());
    }
    ...
    public static function createNewTestUser(Connection $connection, array $permissions = []): TestUser
    {
        ...
        return new TestUser('heypanel', $username, Uuid::fromBytesToHex($userId));
    }
