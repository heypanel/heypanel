...
namespace HeyPanel\Core\Framework\SystemCheck\Command;
...
use HeyPanel\Core\Framework\SystemCheck\SystemChecker;
 ...
 */
#[AsCommand(name: 'system:check', description: 'Check the heypanel application system health')]
