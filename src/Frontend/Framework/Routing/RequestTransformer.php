...
use HeyPanel\Core\Content\Seo\AbstractSeoResolver;
use HeyPanel\Core\Framework\Routing\RequestTransformerInterface;
use HeyPanel\Core\PlatformRequest;
use HeyPanel\Frontend\Framework\Routing\Exception\ChannelMappingException;
