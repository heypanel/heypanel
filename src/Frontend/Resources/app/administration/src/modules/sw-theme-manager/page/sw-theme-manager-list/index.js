...
Component.register('sw-theme-manager-list', {
    ...
    methods: {
        ...
        getList() {
            ...
            return this.themeRepository.search(criteria, HeyPanel.Context.api).then((searchResult) => {
        ...
        onChangeLanguage(languageId) {
            HeyPanel.Context.api.languageId = languageId;
            this.resetList();
        },
        ...
        saveTheme(theme) {
            this.isLoading = true;
            return this.themeRepository.save(theme, HeyPanel.Context.api).then(() => {
                this.isLoading = false;
            }).catch(() => {
                this.isLoading = false;
            });
