...
Mixin.register('theme', {
    ...
    methods: {
        ...
        deleteTheme(theme) {
            ...
            this.isLoading = true;
            this.themeRepository.delete(theme.id, HeyPanel.Context.api).then(() => {
                if (this.getList) {
                    this.getList();
                    return;
                }
        ...
        duplicateTheme(parentTheme, name) {
            const themeDuplicate = this.themeRepository.create(HeyPanel.Context.api);
            ...
            this.themeRepository.save(themeDuplicate, HeyPanel.Context.api).then(() => {
        ...
        RenameTheme(theme, name) {
            ...
            this.themeRepository.save(theme, HeyPanel.Context.api);
        }
    }
});
