 ...
 * @private - Only to be used by heyadmin directly
 *
...
export default function viteOverridePlugin(options: Options): Plugin {
    ...
    return {
        name: 'heyadmin-vite-plugin-override-component',
        ...
        transform(code, id) {
            ...
            const registers = componentNames
                .map((name) => {
                    return `HeyAdmin.Component.registerOverrideComponent(${name});`;
                })
                .join('\n');
            ...
            return {
                code: `
                /* Start: auto generated by HeyAdmin */\n
                ${imports}\n${registers}\n
                /* End: auto generated by HeyAdmin */\n\n
                ${code}`,
                map: null,
            };
        },
