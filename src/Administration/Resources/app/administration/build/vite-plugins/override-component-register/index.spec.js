...
describe('build/vite-plugins/override-component-register', () => {
    ...
    it('should return an object with a name, configResolved and transform property', () => {
        ...
        expect(plugin.name).toBe('heyadmin-vite-plugin-override-component');
    ...
    it('should transform entry file correctly', () => {
        ...
        expect(result.code).toContain('/* Start: auto generated by HeyAdmin */');
        expect(result.code).toContain(
            "import _swspecfoo from './build/vite-plugins/override-component-register/_fixtures/sw-spec_foo.override.vue';",
        );
        expect(result.code).toContain('HeyAdmin.Component.registerOverrideComponent(_swspecfoo);');
        expect(result.code).toContain('/* End: auto generated by HeyAdmin */');
    });
});
