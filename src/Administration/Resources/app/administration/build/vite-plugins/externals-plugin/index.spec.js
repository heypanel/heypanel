...
describe('build/vite-plugins/externals-plugin', () => {
    ...
    it('should return an object with a name and config property', () => {
        ...
        expect(plugin.name).toBe('heyadmin-vite-plugin-vue-globals');
    ...
    it('should add vue alias for config without own alias', async () => {
        ...
        expect(vueAlias.replacement.endsWith('node_modules/.heyadmin-vite-plugin-vue-globals/vue.js')).toBe(true);
    });
    ...
    it('should add vue alias for config with own alias', async () => {
        ...
        expect(vue.replacement.endsWith('node_modules/.heyadmin-vite-plugin-vue-globals/vue.js')).toBe(true);
    });
});
