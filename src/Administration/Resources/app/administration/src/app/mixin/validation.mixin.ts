    ...
    defineComponent({
        ...
        methods: {
            ...
            validate(value: any) {
                ...
                if (HeyPanel.Utils.types.isBoolean(validation)) {
                    return validation;
                }

                if (HeyPanel.Utils.types.isString(validation)) {
                ...
                if (HeyPanel.Utils.types.isArray(validation)) {
                    valid = validation.every((validationRule) => {
                        if (HeyPanel.Utils.types.isBoolean(validationRule)) {
                            return validationRule;
                        }

                        if (HeyPanel.Utils.types.isString(validationRule)) {
