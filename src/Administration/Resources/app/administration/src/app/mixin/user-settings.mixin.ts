        ...
        methods: {
            ...
            getUserSettingsEntity(identifier: string, userId: string | null = null) {
                ...
                return this.userConfigRepository
                    .search(this.userGridSettingsCriteria(identifier, userId), HeyPanel.Context.api)
                    .then((response) => {
                        if (!response.length) {
                            return null;
                        }
            ...
            async saveUserSettings(
                ...
                if (!userSettings) {
                    userSettings = this.userConfigRepository.create(HeyPanel.Context.api);
                }
                ...
                return this.userConfigRepository.save(entityData, HeyPanel.Context.api);
            },
            ...
            userGridSettingsCriteria(identifier: string, userId: string | null = null) {
                ...
                const criteria = new HeyPanel.Data.Criteria(1, 25);
                criteria.addFilter(HeyPanel.Data.Criteria.equals('key', identifier));
                criteria.addFilter(HeyPanel.Data.Criteria.equals('userId', userId));
