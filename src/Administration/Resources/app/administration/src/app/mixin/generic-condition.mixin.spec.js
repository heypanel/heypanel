...
// Mock Component
HeyPanel.Component.register('sw-mock', {
...
describe('app/mixin/generic-condition', () => {
    ...
    beforeEach(async () => {
        wrapper = shallowMount(await HeyPanel.Component.build('sw-mock'), {
            global: {
                mixins: [
                    HeyPanel.Mixin.getByName('generic-condition'),
                ],
                mocks: {
                    condition: {
        ...
        HeyPanel.Store.get('ruleConditionsConfig').config = config;
    });
