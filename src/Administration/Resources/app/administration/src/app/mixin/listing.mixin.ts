...
export default HeyPanel.Mixin.register(
    ...
    defineComponent({
        ...
        created() {
            ...
            if (HeyPanel.Utils.types.isEmpty(actualQueryParameters)) {
                this.resetListing();
            } else {
        ...
        watch: {
            ...
            $route(newRoute, oldRoute) {
                ...
                if (HeyPanel.Utils.types.isEmpty(query)) {
                    this.resetListing();
                }
            ...
            selection() {
                HeyPanel.Store.get('swBulkEdit').selectedIds = Object.keys(this.selection);
            },
