...
describe('entity-collection.data.ts', () => {
    ...
    it('should configure rule awareness configurations', async () => {
        ...
        const ruleAwareness = HeyPanel.Service('ruleConditionDataProviderService').awarenessConfiguration;
    ...
    it('should register conditions with correct scope', async () => {
        const condition = HeyPanel.Service('ruleConditionDataProviderService').getByType('language');
    ...
    it('should add app script conditions', async () => {
        HeyPanel.Service('ruleConditionDataProviderService').addScriptConditions([
            {
                id: 'bar',
                name: 'foo',
                group: 'misc',
        ...
        const condition = HeyPanel.Service('ruleConditionDataProviderService').getByType('bar');
