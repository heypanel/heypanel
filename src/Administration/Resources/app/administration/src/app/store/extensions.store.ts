 ...
 * @private
 */
import { setExtensions } from '@heypanel-ag/meteor-admin-sdk/es/channel';
import type { privileges } from '@heypanel-ag/meteor-admin-sdk/es/_internals/privileges';
...
const extensions = HeyPanel.Store.register({
    id: 'extensions',
    ...
    getters: {
        privilegedExtensionBaseUrls(state) {
            const acl = HeyPanel.Service('acl');
