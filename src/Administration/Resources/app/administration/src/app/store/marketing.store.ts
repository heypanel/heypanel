...
const marketingStore = HeyPanel.Store.register({
    id: 'marketing',
        ...
        setCampaign(campaign: Campaign) {
            ...
            Object.entries(translations).forEach(
                ([
                    ...
                    HeyPanel.Snippet.mergeLocaleMessage(langIsoCode, snippets);
                },
            );
        },
    ...
    getters: {
        getActiveCampaign(): null | Campaign {
            ...
            if (
                HeyPanel.Service('heypanelDiscountCampaignService')?.isDiscountCampaignActive(
