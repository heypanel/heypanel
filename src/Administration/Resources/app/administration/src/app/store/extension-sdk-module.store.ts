 ...
 * @private
 */
import type { smartBarButtonAdd } from '@heypanel-ag/meteor-admin-sdk/es/ui/main-module/';
...
const extensionSdkModules = HeyPanel.Store.register({
    ...
    actions: {
        addModule({
            ...
            const id = HeyPanel.Utils.format.md5(JSON.stringify(staticElements));
