 ...
 */
import type { uiComponentSectionRenderer } from '@heypanel-ag/meteor-admin-sdk/es/ui/component-section';
...
const ExtensionComponentSectionsStore = HeyPanel.Store.register({
