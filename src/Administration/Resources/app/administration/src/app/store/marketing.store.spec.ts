...
describe('marketing.store', () => {
    let store = HeyPanel.Store.get('marketing');
    ...
    beforeEach(() => {
        store = HeyPanel.Store.get('marketing');
        store.campaign = {};
    ...
    it('should set a new campaign', () => {
        HeyPanel.Store.get('marketing').setCampaign({
            name: 'Example campaign',
            components: {},
        });

        expect(HeyPanel.Store.get('marketing').campaign).toEqual({
            name: 'Example campaign',
            components: {},
        });
    });
    ...
    it('should return the active campaign when times match', () => {
        ...
        const activeCampaign = HeyPanel.Store.get('marketing').getActiveCampaign;
    ...
    it('should return the correct component for the store banner when time match', () => {
        ...
        const storeComponent = HeyPanel.Store.get('marketing').getActiveCampaignDataForComponent('storeBanner');
