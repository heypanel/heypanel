...
export function initializeUserNotifications() {
    if (HeyPanel.Store) {
        HeyPanel.Store.get('notification').notifications = getNotificationsForUser();
    }
}
...
function _getStorageKey() {
    const user = HeyPanel.Store.get('session').currentUser;
...
const notificationStore = HeyPanel.Store.register({
    id: 'notification',
