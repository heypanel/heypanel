 ...
 * @private
 */
export default function setupHeyPanelDevtools(app: App): void {
    setupDevtoolsPlugin(
        {
            // Options
            id: 'sw-admin-extension-plugin',
            label: 'HeyPanel Admin extensions plugin',
        ...
        `;
            ...
            api.on.getInspectorTree((payload) => {
                ...
                const publishedDatasets = HeyPanel.ExtensionAPI.getPublishedDataSets();
            ...
            api.on.getInspectorState((payload) => {
                ...
                if (payload.nodeId.startsWith(DATASET_ID_PREFIX)) {
                    ...
                    const value =
                        HeyPanel.ExtensionAPI.getPublishedDataSets().find((set) => set.id === datasetId)?.data ?? 'unknown';
