...
const Application = HeyPanel.Application;
...
describe('app/service/license-violation.service.js', () => {
    HeyPanel.Service().register('heypanelExtensionService', () => extensionApiServiceMock);
    HeyPanel.Service().register('cacheApiService', () => cacheApiServiceMock);
