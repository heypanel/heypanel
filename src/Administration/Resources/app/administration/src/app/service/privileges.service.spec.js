...
describe('src/app/service/privileges.service.js', () => {
    ...
    it('should return the function getPrivilegesWithDependencies without adding admin identifier', async () => {
        ...
        const returnFunction = privilegesService.getPrivileges('question.editor');
        expect(privilegesService._getPrivilegesWithDependencies).not.toHaveBeenCalled();

        expect(typeof returnFunction).toBe('function');
        returnFunction();

        expect(privilegesService._getPrivilegesWithDependencies).toHaveBeenCalledWith('question.editor', false);
    });
    ...
    it('should not call duplicated getPrivileges again', async () => {
        ...
        const privilegeMappingProduct = {
            ...
            roles: {
                viewer: {
                    privileges: ['question:read'],
                    dependencies: [],
                },
                editor: {
                    privileges: ['question:update'],
                    dependencies: [
                        'question.viewer',
                    ],
                },
        ...
        const privilegeMappingRule = {
            ...
            roles: {
                ...
                editor: {
                    privileges: [
                        'rule:update',
                        privilegesService.getPrivileges('question.creator'),
                    ],
                    dependencies: [
                        'rule.viewer',
                    ],
    ...
    it('should merge existing roles', async () => {
        ...
        const privilegeMappingCore = {
            ...
            roles: {
                ...
                editor: {
                    privileges: ['question:update'],
                    dependencies: ['question.viewer'],
                },
                creator: {
                    privileges: ['question:create'],
                    dependencies: [
                        'question.viewer',
                        'question.editor',
                    ],
