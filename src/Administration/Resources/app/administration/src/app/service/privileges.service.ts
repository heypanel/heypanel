...
const { warn, error } = HeyPanel.Utils.debug;
...
export default class PrivilegesService {
     ...
     *
     * Example:
     * question.viewer => Valid
     * question:read => Invalid
     */
    ...
    private _getPrivilegesWithDependencies(adminPrivilegeKey: string, shouldAddAdminPrivilege = true): string[] {
        ...
        /**
         * Get all privileges (['question:read', fn(), 'question:update', ...])
         * and dependencies (['question.viewer', ...])
         */
     ...
     *             privileges: [
     *                 'question.read',
     *                 HeyPanel.Service('privileges').getPrivileges('rule.viewer')
     *             ],
     *             dependencies: []
     *         }
     *     }
     ...
     *      ...
     *    ]
     * getPrivilegesForAdminPrivilegeKeys(['promotion.viewer', 'question.creator'])
     */
