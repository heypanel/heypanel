...
HeyPanel.Service().register('userConfigService', () => {
    return {
...
describe('app/service/search-ranking.service.js', () => {
    ...
    const searchFieldsByEntityCases = [
        [
            ...
            {
                'question.name': searchRankingPoint.HIGH_SEARCH_RANKING,
                'question.options.name': searchRankingPoint.LOW_SEARCH_RANKING,
            },
        ],
        [
    ...
    const buildingCriteriaScoreQueryCase = [
        [
            ...
            new Criteria(1, 25).addQuery(Criteria.contains('question.name', 'order'), searchRankingPoint.HIGH_SEARCH_RANKING),
        ],
        [
        ...
        [
            ...
            new Criteria(1, 25)
                .addQuery(Criteria.contains('question.name', 'order'), searchRankingPoint.HIGH_SEARCH_RANKING)
                .addQuery(Criteria.contains('question.name', 'category'), searchRankingPoint.HIGH_SEARCH_RANKING),
        ],
        [
        ...
        [
            ...
            new Criteria(1, 25).addQuery(Criteria.contains('question.name', 'same'), searchRankingPoint.HIGH_SEARCH_RANKING),
        ],
        [
            'term is undefined',
            undefined,
    ...
    const userConfigSearchPreferenceCase = [
        ...
        [
            ...
            {
                'question.name': searchRankingPoint.LOW_SEARCH_RANKING,
            },
        ],
        [
    ...
    function clearModules() {
        HeyPanel.Module.getModuleRegistry().clear();
    }

    function createModules(modules) {
        modules.forEach((module) => {
            HeyPanel.Module.register(module.name, module);
        });
    }
    ...
    function addDataToRegisterUserConfigService(userConfigSearchs) {
        ...
        HeyPanel.Service('userConfigService').search = () => Promise.resolve({ data });
    }
    ...
    it.each(searchFieldsByEntityCases)(
        ...
        async (testName, searchFields, expected) => {
            ...
            const actual = await service.getSearchFieldsByEntity('question');
            expect(actual).toEqual(expected);
        },
    );
    ...
    it('Should cache the result when get search fields by entity', async () => {
        ...
        createModules([module]);
        const firstResult = await service.getSearchFieldsByEntity('question');
        ...
        const secondResult = await service.getSearchFieldsByEntity('question');
    ...
    it.each(userConfigSearchPreferenceCase)(
        ...
        async (testName, defaultSearchFields, userConfigSearchFields, expected) => {
            ...
            const actual = await newService.getSearchFieldsByEntity('question');
    ...
    it('Should add default search configuration of a new module to current user search preferences', async () => {
        ...
        expect(actual).toEqual({
            question: { 'question.name': searchRankingPoint.HIGH_SEARCH_RANKING },
    ...
    it("Should remove an entity's search configurations from current user search preferences when entity's module does not have default search configurations", async () => {
        ...
        addDataToRegisterUserConfigService([
            ...
            {
                question: { ...commonSearchConfigurations },
            },
        ]);
    ...
    it('Should cache the result when getting user search configuration through the API', async () => {
        ...
        const newService = new SearchRankingService();
        let actual = await newService.getSearchFieldsByEntity('question');
        const expected = {
            'question.name': searchRankingPoint.LOW_SEARCH_RANKING,
        };
        ...
        actual = await newService.getSearchFieldsByEntity('question');
