...
describe('src/app/filter/thumbnail-size.filter.ts', () => {
    const thumbnailSizeFilter = HeyPanel.Filter.getByName('thumbnailSize');
    const mediaThumbnailFactory = HeyPanel.Service('repositoryFactory').create('media_thumbnail_size');
