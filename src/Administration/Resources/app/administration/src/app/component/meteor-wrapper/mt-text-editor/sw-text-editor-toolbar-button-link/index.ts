...
import type { CustomButton } from '@heypanel-ag/meteor-component-library/dist/esm/components/form/mt-text-editor/_internal/mt-text-editor-toolbar';
    ...
    computed: {
        linkOptions() {
            return [
                ...
                {
                    id: 'detail',
                    label: this.$t('sw-text-editor-toolbar-button-link.linkOptions.question'),
                    value: 'detail',
                },
                {
                    id: 'navigation',
        ...
        questionEntityFilter(): CriteriaType {
            ...
            criteria.addFilter(
                Criteria.multi('OR', [
                    Criteria.equals('question.childCount', 0),
                    Criteria.equals('question.childCount', null),
                ]),
            );
