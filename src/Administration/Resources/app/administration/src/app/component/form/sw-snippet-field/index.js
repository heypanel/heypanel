...
export default {
    ...
    computed: {
        ...
        languageCriteria() {
            ...
            criteria.addFilter(Criteria.equals('id', HeyPanel.Context.api.systemLanguageId));
    ...
    methods: {
        async createdComponent() {
            ...
            this.snippetSets = await this.snippetSetRepository.search(new Criteria(), HeyPanel.Context.api);
        ...
        async updatePlaceholderValueToSnippetTranslation() {
            ...
            const currentLocale = HeyPanel.Store.get('session').currentLocale;
        ...
        async getSystemDefaultLocale() {
            const languages = await this.languageRepository.search(this.languageCriteria, HeyPanel.Context.api);
