    ...
    methods: {
        ...
        showSearch() {
            ...
            this.propertyGroupOptionRepository
                .search(this.propertyGroupOptionCriteria, HeyPanel.Context.api)
                .then((groupOptions) => {
        ...
        loadGroups() {
            this.propertyGroupRepository.search(this.propertyGroupCriteria, HeyPanel.Context.api).then((groups) => {
                this.groups = groups;
