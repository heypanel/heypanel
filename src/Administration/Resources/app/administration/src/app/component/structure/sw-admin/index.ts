import type { Toast } from '@heypanel-ag/meteor-component-library/dist/esm/components/feedback-indicator/mt-toast/mt-toast';
...
export default HeyPanel.Component.wrapComponentConfig({
    ...
    metaInfo() {
        return {
            title: this.$tc('global.sw-admin-menu.textHeyPanelAdmin'),
        };
    },
    ...
    created() {
        HeyPanel.ExtensionAPI.handle('toastDispatch', (toast) => {
            this.toasts = [
                {
        ...
        this.channel.onmessage = (event) => {
            ...
            if (!data || !HeyPanel.Utils.object.hasOwnProperty(data, 'inactive')) {
                return;
            }
