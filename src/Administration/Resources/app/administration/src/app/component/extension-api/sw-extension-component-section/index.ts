...
export default HeyPanel.Component.wrapComponentConfig({
    ...
    props: {
        ...
        /**
         * Will mark the component section as deprecated, causing a warning in questionion and error in dev environments.
         */
        deprecated: {
            type: Boolean,
            required: false,
    ...
    computed: {
        componentSections(): ComponentSectionEntry[] {
            const sections = HeyPanel.Store.get('extensionComponentSections').identifier[this.positionIdentifier] ?? [];
