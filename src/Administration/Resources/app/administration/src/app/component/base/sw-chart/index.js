...
export default {
    ...
    computed: {
        ...
        defaultLocale() {
            const adminLocaleLanguage = HeyPanel.Store.get('session').adminLocaleLanguage;
    ...
    methods: {
        ...
        getZeroValues() {
            ...
            const fromDate = HeyPanel.Utils.format.dateWithUserTimezone();
            ...
            if (this.options.xaxis.max) {
                ...
                // get actual day
                const toDate = HeyPanel.Utils.format.dateWithUserTimezone();
