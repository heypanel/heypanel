        ...
        global: {
            ...
            stubs: {
                ...
                'sw-question-variant-info': {
                    template: '<div class="sw-question-variant-info"><slot></slot></div>',
                },
...
describe('components/rule/condition-type/sw-condition-script', () => {
    it('should render fields and set condition values on change', async () => {
        ...
        expect(wrapper.vm.condition.value.questionIds).toBeUndefined();
        expect(wrapper.vm.values.operator).toBeUndefined();
        expect(wrapper.vm.values.firstName).toBeUndefined();
        expect(wrapper.vm.values.questionIds).toEqual([]);
        ...
        expect(wrapper.vm.condition.value.questionIds).toEqual(
