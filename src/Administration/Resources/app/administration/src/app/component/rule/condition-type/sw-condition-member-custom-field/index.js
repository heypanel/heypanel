import template from './sw-condition-member-custom-field.html.twig';
import './sw-condition-member-custom-field.scss';

const { Component, Filter, Mixin } = HeyPanel;
 ...
 * @component-example
 * <sw-condition-member-custom-field :condition="condition"></sw-condition-member-custom-field>
 */
...
export default {
    ...
    computed: {
        ...
        customFieldCriteria() {
            ...
            criteria.addFilter(Criteria.equals('customFieldSet.relations.entityName', 'member'));
