...
const { fileReader } = HeyPanel.Utils;
const { fileSize } = HeyPanel.Utils.format;
...
export default {
    ...
    data() {
        return {
            ...
            isUploadUrlFeatureEnabled: HeyPanel.Store.get('context').app.config?.settings?.enableUrlFeature ?? false,
            isLoading: false,
        };
    },
    ...
    computed: {
        ...
        mediaNameFilter() {
            return HeyPanel.Filter.getByName('mediaName');
        },
    },
