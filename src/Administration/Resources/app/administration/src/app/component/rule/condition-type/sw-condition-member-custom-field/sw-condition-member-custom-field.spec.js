...
async function createWrapper() {
    return mount(
        await wrapTestComponent('sw-condition-member-custom-field', {
            sync: true,
        }),
        {
            global: {
                directives: {
                    popover: HeyPanel.Directive.getByName('popover'),
                },
                stubs: {
...
describe('components/rule/condition-type/sw-condition-member-custom-field', () => {
    let wrapper;
