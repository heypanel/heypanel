...
export default {
    ...
    computed: {
        violations() {
            return HeyPanel.Store.get('licenseViolation').violations;
        },

        warnings() {
            return HeyPanel.Store.get('licenseViolation').warnings;
        },
        ...
        pluginCriteria() {
            return new HeyPanel.Data.Criteria(1, 50);
        },
        ...
        getPluginViolation() {
            ...
            return this.licenseViolationService
                ...
                .then(({ violations, warnings, other }) => {
                    const licenseViolationStore = HeyPanel.Store.get('licenseViolation');
