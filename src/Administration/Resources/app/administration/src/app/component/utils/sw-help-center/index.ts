...
export default HeyPanel.Component.wrapComponentConfig({
    ...
    computed: {
        showHelpSidebar(): boolean {
            return HeyPanel.Store.get('adminHelpCenter').showHelpSidebar;
        },

        showShortcutModal(): boolean {
            return HeyPanel.Store.get('adminHelpCenter').showShortcutModal;
        },
    },
    ...
    methods: {
        openHelpSidebar(): void {
            HeyPanel.Store.get('adminHelpCenter').showHelpSidebar = true;
        },

        openShortcutModal(): void {
            HeyPanel.Store.get('adminHelpCenter').showShortcutModal = true;
        },

        closeShortcutModal(): void {
            HeyPanel.Store.get('adminHelpCenter').showShortcutModal = false;
        },
