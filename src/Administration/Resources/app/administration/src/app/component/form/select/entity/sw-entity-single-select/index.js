...
const { debounce, get } = HeyPanel.Utils;
...
export default {
    ...
    props: {
        ...
        entityCreationLabel: {
            ...
            required: false,
            default() {
                return HeyPanel.Snippet.tc('global.sw-single-select.labelEntity');
            },
        },
        ...
        createNewEntity() {
            ...
            this.repository
                ...
                .catch(() => {
                    ...
                    HeyPanel.Utils.debug.error('Only Entities with "name" as the only required field are creatable.');
                    this.isLoading = false;
                });
        },
