...
describe('components/form/sw-url-field', () => {
    ...
    it('properly detects SSL', async () => {
        const SSL_URL = 'https://heypanel.com';
        const NON_SSL_URL = 'http://heypanel.com';
        const URL_WITHOUT_PROTOCOL = 'heypanel.com';
    ...
    it('removes any protocol', async () => {
        const HTTP_URL = 'http://heypanel.com';
        const HTTPS_URL = 'https://heypanel.com';
        const FILE_URL = 'file://heypanel.com';
        const EXPECTED_URL = 'heypanel.com';
    ...
    it('allows empty values', async () => {
        const INITIAL_URL = 'https://heypanel.com';
        const URL_WITHOUT_PROTOCOL = 'heypanel.com';
        const EXPECTED_URL = '';
    ...
    it('should update empty values', async () => {
        const wrapper = await createWrapper({
            props: {
                value: 'https://heypanel.com',
            },
        });
        await flushPromises();

        const input = wrapper.find('input');
        expect(input.element.value).toBe('heypanel.com');
    ...
    it('adds the trailing slash if the prop is set', async () => {
        ...
        await input.setValue('heypanel.com');
        await input.trigger('blur');
        await nextTick();
        expect(wrapper.vm.currentUrlValue).toBe('heypanel.com/');
        expect(wrapper.emitted('update:value')).toStrictEqual([
            ['https://heypanel.com/'],
        ]);
    });
