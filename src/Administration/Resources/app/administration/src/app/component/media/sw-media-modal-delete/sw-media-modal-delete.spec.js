...
describe('components/media/sw-media-modal-delete', () => {
    ...
    it('should return list of Media with only one media selected', async () => {
        ...
        const wrapper = await createWrapper([
            itemDeleteMock({ questionMedia: [questionMediaMock] }),
        ]);

        expect(wrapper.vm.mediaQuickInfo.fileName).toMatch(itemDeleteMock().fileName);
        expect(wrapper.vm.mediaQuickInfo.questionMedia).toEqual([
            questionMediaMock,
        ]);
    ...
    it('should return list of Media quick info usage with all of places already linked', async () => {
        ...
        const questionManufacturer = { id: '923hf9202jd02j29d72h20' };
        ...
        const questionMedia = { id: 'f83hf3dn2k5nv83020283jf9320' };
        const cmsBlock = {
            section: {
                pageId: 'cmsBlockId',
        ...
        const wrapper = await createWrapper([
            itemDeleteMock({
                ...
                categories: [category],
                questionManufacturers: [questionManufacturer],
        ...
        expect(wrapper.vm.mediaQuickInfo.questionManufacturers).toEqual([
            questionManufacturer,
        ]);
        expect(wrapper.vm.mediaQuickInfo.questionMedia).toEqual([questionMedia]);
    ...
    it('should return list of File have media in usage with more than one media selected', async () => {
        ...
        const manyMediaItemMock = [
            itemDeleteMock({
                ...
                questionMedia: [questionMediaMock],
            }),
            itemDeleteMock({
