...
export default {
    ...
    methods: {
        ...
        getTreeItems(parentId = null) {
            ...
            return this.globalCategoryRepository.search(criteria, HeyPanel.Context.api).then((searchResult) => {
        ...
        searchCategories(term) {
            ...
            // search for categories
            return this.globalCategoryRepository.search(categorySearchCriteria, HeyPanel.Context.api);
        },
