...
describe('src/app/component/structure/sw-language-info', () => {
    ...
    beforeEach(async () => {
        HeyPanel.Store.get('context').api.languageId = '123456789';
        HeyPanel.Store.get('context').api.systemLanguageId = 123456789;
        HeyPanel.Store.get('context').api.language = {
            id: '123',
            parentId: '456',
        };
    ...
    it('should not render the infoText when no language is set', async () => {
        ...
        HeyPanel.Store.get('context').api.language = null;
    ...
    it('should not render the infoText when user is in default language', async () => {
        ...
        HeyPanel.Store.get('context').api.languageId = '123';
        HeyPanel.Store.get('context').api.systemLanguageId = '123';
    ...
    it('should render the infoText for a root language', async () => {
        HeyPanel.Store.get('context').api.systemLanguageId = '987654312';
        HeyPanel.Store.get('context').api.language = {
            id: '1a2b3c',
            parentId: null,
        };
