...
export default {
    ...
    methods: {
        ...
        addEventListeners() {
            ...
            HeyPanel.Utils.EventBus.on('item-select', this.onItemSelect);
        },
        ...
        removeEventListeners() {
            ...
            HeyPanel.Utils.EventBus.off('item-select', this.onItemSelect);
        },
        ...
        emitActiveItemIndex(shouldFocus = false) {
            ...
            HeyPanel.Utils.EventBus.emit('active-item-change', this.activeItemIndex, {
                shouldFocus,
            });
        },
        ...
        emitClicked() {
            ...
            HeyPanel.Utils.EventBus.emit('item-select-by-keyboard', this.activeItemIndex);
        },
