...
export default {
    ...
    computed: {
        ...
        currentAuthor() {
            return `user/${HeyPanel.Store.get('session').currentUser.username}`;
        },
    ...
    methods: {
        createdComponent() {
            ...
            this.snippetSets.forEach((snippetSet) => {
                ...
                const snippet = this.snippetRepository.create(HeyPanel.Context.api);
        ...
        onSave() {
            ...
            this.editableSnippets.forEach((snippet) => {
                ...
                if (snippet.origin !== snippet.value) {
                    ...
                    responses.push(this.snippetRepository.save(snippet, HeyPanel.Context.api));
                    ...
                    responses.push(this.snippetRepository.delete(snippet.id, HeyPanel.Context.api));
                }
            });
