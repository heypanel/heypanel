...
import { MtTextEditorToolbarButton, MtModalClose, MtModal, MtModalRoot } from '@heypanel-ag/meteor-component-library';
...
describe('src/app/component/meteor-wrapper/mt-text-editor/mt-text-editor-toolbar-button-link', () => {
    ...
    it('should insert the correct link (linkType = "link")', async () => {
        ...
        await linkUrlInput.setValue('https://www.heypanel.com');
