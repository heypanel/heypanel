...
export default {
    ...
    methods: {
        createdComponent() {
            HeyPanel.Utils.EventBus.on('active-item-change', this.checkIfActive);
            HeyPanel.Utils.EventBus.on('item-select-by-keyboard', this.checkIfSelected);
        },

        destroyedComponent() {
            HeyPanel.Utils.EventBus.off('active-item-change', this.checkIfActive);
            HeyPanel.Utils.EventBus.off('item-select-by-keyboard', this.checkIfSelected);
        },
        ...
        onClickResult() {
            ...
            HeyPanel.Utils.EventBus.emit('item-select', this.item);
        },
