        ...
        props: {
            ...
            conditionRepository: {
                create: () => {
                    return {
                        apiAlias: null,
                        children: new EntityCollection('', 'rule_condition', HeyPanel.Context.api),
                        customFields: null,
                        id: 'id1',
                        parentId: null,
                        position: 0,
...
describe('src/app/component/rule/sw-condition-tree', () => {
    ...
    describe('provides', () => {
        function createInitialOrContainer() {
            return new EntityCollection(null, 'rule_condition', HeyPanel.Context.api, new Criteria(), [
                {
                    id: 'id1',
                    children: new EntityCollection('', 'rule_condition', HeyPanel.Context.api),
                    type: 'orContainer',
        ...
        function createInitialTree() {
            return {
                id: 'parent-id',
                children: new EntityCollection('', 'rule_condition', HeyPanel.Context.api, null, [
                    {
                        id: 'id-first-child',
                        position: 0,
                        parentId: 'parent-id',
