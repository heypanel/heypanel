...
export default {
    ...
    methods: {
        ...
        findUserSetting() {
            ...
            return this.userConfigRepository.search(this.userGridSettingCriteria, HeyPanel.Context.api).then((response) => {
                if (!response.length) {
                    return;
                }
        ...
        findUserSettingById() {
            return this.userConfigRepository.get(this.currentSetting.id, HeyPanel.Context.api).then((response) => {
                if (!response) {
                    return;
                }
        ...
        createUserGridSetting() {
            const newUserGrid = this.userConfigRepository.create(HeyPanel.Context.api);
        ...
        saveUserSettings() {
            ...
            this.userConfigRepository.save(this.currentSetting, HeyPanel.Context.api).then(() => {
