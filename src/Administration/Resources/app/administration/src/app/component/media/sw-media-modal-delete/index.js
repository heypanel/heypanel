...
const { Context, Mixin, Filter } = HeyPanel;
    ...
    methods: {
        ...
        async updateSuccessNotification(successAmount, failureAmount, totalAmount) {
            ...
            if (this.notificationId !== null) {
                await HeyPanel.Store.get('notification').updateNotification({
            ...
            const newNotificationId = await HeyPanel.Store.get('notification').createNotification({
                variant: 'success',
                ...notification,
            });
