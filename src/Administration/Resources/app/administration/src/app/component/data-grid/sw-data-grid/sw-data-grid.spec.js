...
const defaultUserConfig = {
    ...
    key: 'grid.setting.sw-member-list',
...
describe('components/data-grid/sw-data-grid', () => {
    ...
    const cases = {
        ...
        'test null object': {
            accessor: 'payload.memberId',
            expected: null,
            errorMsg: '[[sw-data-grid] Can not resolve accessor: payload.memberId]',
        },
        'test nested null object': {
            accessor: 'member.type.name',
            expected: null,
            errorMsg: '[[sw-data-grid] Can not resolve accessor: member.type.name]',
        },
    };
    ...
    Object.entries(cases).forEach(
        ([
            ...
            it(`should render columns with ${key}`, async () => {
                jest.spyOn(HeyPanel.Utils.debug, 'warn').mockImplementation(() => {});
                ...
                const data = {
                    ...
                    manufacturer: new Entity('test', 'question_manufacturer', {
    ...
    it('should pre select grid using preSelection prop', async () => {
        ...
        const wrapper = await createWrapper({
            identifier: 'sw-member-list-identifier',
            preSelection,
        });
