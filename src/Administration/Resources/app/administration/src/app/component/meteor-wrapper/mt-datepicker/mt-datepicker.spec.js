...
describe('src/app/component/meteor-wrapper/mt-datepicker', () => {
    beforeAll(() => {
        HeyPanel.Store.get('system').registerAdminLocale('de-DE');
        HeyPanel.Store.get('system').registerAdminLocale('en-GB');
    });
    ...
    beforeEach(() => {
        ...
        HeyPanel.Store.get('session').setAdminLocale('de-DE');
    });
    ...
    it('should use the user locale (en)', async () => {
        ...
        HeyPanel.Store.get('session').setAdminLocale('en-GB');
