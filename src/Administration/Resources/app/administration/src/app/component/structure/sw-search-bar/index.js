...
const { Application, Context } = HeyPanel;
...
export default {
    ...
    props: {
        /**
         * Determines if the initial search entity, e.g. for a search only in questions, when entering its list
         */
        initialSearchType: {
            type: String,
            required: false,
    ...
    computed: {
        ...
        criteriaCollection() {
            return {
                question: new Criteria(1, this.searchLimit + 1).addAssociation('options.group'),
            };
        },
    ...
    methods: {
        ...
        showSearchBar() {
            ...
            HeyPanel.Utils.EventBus.emit('sw-admin-menu/toggle-offcanvas', this.isOffCanvasShown);
        },
