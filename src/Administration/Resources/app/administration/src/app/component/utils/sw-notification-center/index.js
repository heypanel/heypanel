...
export default {
    ...
    computed: {
        notifications() {
            return Object.values(HeyPanel.Store.get('notification').notifications).reverse();
        },
    ...
    created() {
        this.unsubscribeFromStore = HeyPanel.Store.get('notification').$onAction(this.createNotificationFromSystemError);
        HeyPanel.Utils.EventBus.on('on-change-notification-center-visibility', this.changeVisibility);
    },
    ...
    methods: {
        onContextMenuOpen() {
            HeyPanel.Store.get('notification').workerProcessPollInterval = POLL_FOREGROUND_INTERVAL;
        },
        onContextMenuClose() {
            HeyPanel.Store.get('notification').setAllNotificationsVisited();
            HeyPanel.Store.get('notification').workerProcessPollInterval = POLL_BACKGROUND_INTERVAL;
        },
        openDeleteModal() {
