...
export default {
    ...
    methods: {
        createdComponent() {
            this.languageId = HeyPanel.Context.api.languageId;
            this.lastLanguageId = this.languageId;

            HeyPanel.Utils.EventBus.on('on-change-language-clicked', this.changeToNewLanguage);
        },

        destroyedComponent() {
            HeyPanel.Utils.EventBus.off('on-change-language-clicked', this.changeToNewLanguage);
        },
        ...
        emitChange() {
            ...
            if (this.changeGlobalLanguage) {
                ...
                HeyPanel.Utils.EventBus.emit('sw-language-switch-change-application-language', {
