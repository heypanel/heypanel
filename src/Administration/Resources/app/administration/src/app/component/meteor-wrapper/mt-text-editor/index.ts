import { MtTextEditor as MtTextEditorOriginal } from '@heypanel-ag/meteor-component-library';
 ...
 * button with a custom implementation specific to the HeyPanel admin.
 */
