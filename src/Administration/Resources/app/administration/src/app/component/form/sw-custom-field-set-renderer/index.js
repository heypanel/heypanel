...
export default {
    ...
    methods: {
        ...
        getBind(customField, props) {
            const customFieldClone = HeyPanel.Utils.object.cloneDeep(customField);
            ...
            if (customFieldClone.config.customFieldType === 'entity' && customFieldClone.config.entity === 'question') {
        ...
        loadCustomFieldSet(setId) {
            ...
            this.customFieldSetRepository
                .get(setId, HeyPanel.Context.api, this.customFieldSetCriteriaById())
                .then((newSet) => {
