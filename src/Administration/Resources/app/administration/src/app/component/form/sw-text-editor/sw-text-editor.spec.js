...
describe('src/app/component/form/sw-text-editor', () => {
    ...
    it('should show the link url when you select a text block with a link', async () => {
        ...
        await addTextToEditor(
            ...
            <p id="paragraphWithLink">
                <a id="linkText" href="http://heypanel.com" target="_self">HeyPanel</a>
            </p>
        `,
        );
        ...
        await addAndCheckSelection(wrapper, linkText, 0, 8, 'HeyPanel');
        document.dispatchEvent(new Event('mouseup'));
        ...
        expect(linkInput.element.value).toBe('http://heypanel.com');
    ...
    it('should show the link url with newTab active when you select a text block with a link', async () => {
        ...
        await addTextToEditor(
            ...
            <p id="paragraphWithLink">
                <a id="linkText" href="http://heypanel.com" target="_blank">HeyPanel</a>
            </p>
        `,
        );
    ...
    it('should be able to switch from active link to non link text', async () => {
        ...
        // select "No Link" after the "HeyPanel" link was selected before
        const paragraphWithoutLink = document.getElementById('paragraphWithoutLink');
    ...
    it('should be able to switch from one link to another link', async () => {
        ...
        await addTextToEditor(
            wrapper,
            `
            <a id="linkOne" href="http://heypanel.com" target="_self">HeyPanel</a>
        ...
        await addAndCheckSelection(wrapper, linkOne, 0, 8, 'HeyPanel');
        document.dispatchEvent(new Event('mouseup'));
        ...
        // select "Google" after the "HeyPanel" link was selected before
    ...
    it('should remove link from text', async () => {
        ...
        await addTextToEditor(
            wrapper,
            '<a href="http://heypanel.com" target="_blank"><bold><u>Shop<strike id="anchor">ware</strike></u></bold></a>',
        );
    ...
    it('should let the toolbar disappear, when containing component unmounts', async () => {
        ...
        await addTextToEditor(
            wrapper,
            '<a href="http://heypanel.com" target="_blank"><bold><u id="content">HeyPanel</u></bold></a>',
        );
