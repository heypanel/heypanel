...
export default {
    ...
    methods: {
        ...
        editItems() {
            ...
            if (this.itemCount > 0) {
                HeyPanel.Store.get('heypanelApps').selectedIds = Object.keys(this.bulkEditSelection);
                HeyPanel.Store.get('swBulkEdit').selectedIds = Object.keys(this.bulkEditSelection);
