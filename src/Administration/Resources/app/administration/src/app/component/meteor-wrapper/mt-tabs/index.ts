import { MtTabs } from '@heypanel-ag/meteor-component-library';
import type { PropType } from 'vue';
import type { TabItem } from '@heypanel-ag/meteor-component-library/dist/esm/components/navigation/mt-tabs/mt-tabs';
...
export default HeyPanel.Component.wrapComponentConfig({
    ...
    computed: {
        tabExtensions(): TabItemEntry[] {
            return HeyPanel.Store.get('tabs').tabItems[this.positionIdentifier] ?? [];
        },
