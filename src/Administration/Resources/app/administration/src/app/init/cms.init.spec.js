...
import * as cms from '@heypanel-ag/meteor-admin-sdk/es/ui/cms';
...
describe('src/app/init/cms.init.ts', () => {
    ...
    it('should handle cmsRegisterElement', async () => {
        ...
        HeyPanel.Service('cmsService').registerCmsElement = mock;
    ...
    it('should handle cmsRegisterBlock', async () => {
        ...
        HeyPanel.Service('cmsService').registerCmsBlock = mock;
