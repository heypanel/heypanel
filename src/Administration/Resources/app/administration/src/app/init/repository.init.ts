...
const RepositoryFactory = HeyPanel.Classes._private.RepositoryFactory;
const { EntityHydrator, ChangesetGenerator, EntityFactory } = HeyPanel.Data;
const ErrorResolverError = HeyPanel.Data.ErrorResolver;
...
export default function initializeRepositoryFactory(container: InitContainer) {
    ...
    const serviceContainer = HeyPanel.Application.getContainer('service');
    ...
    return httpClient
        ...
        .then(({ data }) => {
            ...
            HeyPanel.Application.addServiceProvider('repositoryFactory', () => {
                return new RepositoryFactory(hydrator, changesetGenerator, entityFactory, httpClient, errorResolver);
            });
            HeyPanel.Application.addServiceProvider('entityHydrator', () => {
                return hydrator;
            });
            HeyPanel.Application.addServiceProvider('entityFactory', () => {
