...
import { notification } from '@heypanel-ag/meteor-admin-sdk';
    ...
    it('should handle notificationDispatch requests', async () => {
        await notification.dispatch({
            ...
            actions: [
                ...
                {
                    label: 'Cancel',
                    route: 'https://www.heypanel.com',
                    disabled: false,
                },
            ],
        });

        const growlNotificationKey = Object.keys(HeyPanel.Store.get('notification').growlNotifications)[0];
        expect(HeyPanel.Store.get('notification').growlNotifications).toEqual({
