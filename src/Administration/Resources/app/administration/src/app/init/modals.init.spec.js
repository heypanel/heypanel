...
describe('src/app/init/modals.init.ts', () => {
    ...
    beforeEach(() => {
        HeyPanel.Store.get('modals').modals = [];
    ...
    it('should handle incoming uiModalOpen requests', async () => {
        ...
        expect(HeyPanel.Store.get('modals').modals).toHaveLength(1);
    });
    ...
    it('should handle incoming uiModalClose requests', async () => {
        ...
        expect(HeyPanel.Store.get('modals').modals).toHaveLength(0);
    });
    ...
    it('should not handle requests when extension is not valid', async () => {
        ...
        expect(HeyPanel.Store.get('extensionSdkModules').modules).toHaveLength(0);
    });
    ...
    it('should handle incoming uiModalUpdate requests and update the modal', async () => {
        ...
        expect(HeyPanel.Store.get('modals').modals[0].title).toBe('Initial title');
        ...
        expect(HeyPanel.Store.get('modals').modals[0].title).toBe('Updated title');
        expect(HeyPanel.Store.get('modals').modals[0].variant).toBe('large');
    });
    ...
    it('should update the buttons when uiModalUpdate is called', async () => {
        ...
        expect(HeyPanel.Store.get('modals').modals[0].buttons).toHaveLength(1);
        expect(HeyPanel.Store.get('modals').modals[0].buttons[0].label).toBe('Old Button');
        ...
        expect(HeyPanel.Store.get('modals').modals[0].buttons).toHaveLength(2);
        expect(HeyPanel.Store.get('modals').modals[0].buttons[0].label).toBe('New Button');
        expect(HeyPanel.Store.get('modals').modals[0].buttons[1].label).toBe('Another Button');
    });
});
