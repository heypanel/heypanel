...
export default function initializeShortcutService() {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    const shortcutService = HeyPanel.Service('shortcutService');
...
function defaultShortcutMap() {
    return [
        // Add an entity
        { combination: 'AP', path: '/sw/question/create/base' },
        { combination: 'AC', path: '/sw/category/index' },
        { combination: 'AU', path: '/sw/member/create' },
