...
describe('src/app/init/tabs.init', () => {
    ...
    beforeAll(() => {
        ...
        // Mock component
        HeyPanel.Application.view.getComponent = () => ({});

        // Mock router factory
        HeyPanel.Application.addInitializer('router', () => {
            return new HeyPanel.Classes._private.RouterFactory(
                undefined,
                undefined,
                HeyPanel.Application.getContainer('factory').module,
            );
        });
        ...
        HeyPanel.Application.view.router = routerMock;

        // Add module to registry for receiving meta data
        HeyPanel.Module.register('sw-category', {
            type: 'core',
            name: 'category',
        ...
        HeyPanel.Module.register('sw-settings-usage-data', {
            type: 'core',
            name: 'usage-data',
    ...
    it('should initialize tab extension API correctly', async () => {
        ...
        expect(HeyPanel.Store.get('tabs').tabItems).toHaveProperty('foo-position-id');
        expect(HeyPanel.Store.get('tabs').tabItems['foo-position-id']).toEqual([
            {
                label: 'My tab item',
                componentSectionId: 'foo-component-section-id',
            },
    ...
    it('should create correct route entry for tab item when route gets opened (dynamic route)', async () => {
        ...
        // initialize view
        await HeyPanel.Application._resolveViewInitialized();
