...
describe('module/sw-settings-language/page/sw-settings-language-detail', () => {
    ...
    it('should not be possible to inherit with no system language', async () => {
        ...
        wrapper.vm.language = {
            id: HeyPanel.Context.api.systemLanguageId,
        };
    ...
    it('should load entity data', async () => {
        const wrapper = await createWrapper([], HeyPanel.Context.api.systemLanguageId);
        expect(wrapper.vm.languageId).toBe(HeyPanel.Context.api.systemLanguageId);
        await flushPromises();

        expect(wrapper.vm.language.id).toBe(HeyPanel.Context.api.systemLanguageId);
    });
    ...
    it('should add an asterix to used iso codes', async () => {
        const wrapper = await createWrapper(['language.editor'], HeyPanel.Context.api.systemLanguageId, false);
        await flushPromises();
