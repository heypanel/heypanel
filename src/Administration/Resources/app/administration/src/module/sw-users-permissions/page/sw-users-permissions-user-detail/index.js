...
export default {
    ...
    computed: {
        ...
        languageId() {
            return HeyPanel.Store.get('session').languageId;
        },
    ...
    methods: {
        createdComponent() {
            ...
            this.timezoneOptions = HeyPanel.Service('timezoneService').getTimezoneOptions();
            const languagePromise = new Promise((resolve) => {
                HeyPanel.Store.get('context').api.languageId = this.languageId;
        ...
        loadUser() {
            ...
            return this.userRepository.get(this.userId, HeyPanel.Context.api, this.userCriteria).then((user) => {
                this.user = user;
        ...
        async saveUser(context) {
            ...
            if (this.currentUser.id === this.user.id) {
                await HeyPanel.Service('localeHelper').setLocaleWithId(this.user.localeId);
            }
        ...
        async updateCurrentUser() {
            await this.userService.getUser().then((response) => {
                ...
                HeyPanel.Store.get('session').setCurrentUser(data);
            });
        },
        ...
        async updateAuthToken() {
            ...
            HeyPanel.Store.get('context').api.authToken.access = verifiedToken;
            const authObject = {
