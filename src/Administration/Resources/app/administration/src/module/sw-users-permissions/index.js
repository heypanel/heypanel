...
HeyPanel.Component.register('sw-users-permissions', () => import('./page/sw-users-permissions'));
...
HeyPanel.Component.register('sw-users-permissions-user-detail', () => import('./page/sw-users-permissions-user-detail'));
...
HeyPanel.Component.register('sw-users-permissions-role-detail', () => import('./page/sw-users-permissions-role-detail'));
HeyPanel.Component.register(
...
HeyPanel.Module.register('sw-users-permissions', {
    type: 'core',
