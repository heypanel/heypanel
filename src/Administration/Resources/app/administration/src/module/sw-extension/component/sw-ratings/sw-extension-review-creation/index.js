...
export default {
    ...
    computed: {
        ...
        installedVersion() {
            const installedExtension = HeyPanel.Store.get('heypanelExtensions').myExtensions.data.find(
    ...
    methods: {
        ...
        validateHeadline() {
            if (this.headline === null || this.headline === '') {
                this.errors.headlineError = new HeyPanelError({
        ...
        validateRating() {
            if (this.rating === null || this.rating === 0) {
                this.errors.ratingError = new HeyPanelError({
                    code: 'c1051bb4-d103-4f74-8988-acbcafc7fdc3',
                });
