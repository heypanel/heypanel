        ...
        }),
        {
            global: {
                ...
                provide: {
                    ...
                    heypanelExtensionService: new HeyPanelService({}, {}, {}, {}),
                    cacheApiService: {
                        clear() {
...
describe('src/module/sw-extension/component/sw-self-maintained-extension-card', () => {
    ...
    it('activateExtension should install and reload the page', async () => {
        ...
        wrapper.vm.heypanelExtensionService.activateExtension = jest.fn(() => Promise.resolve());

        wrapper.vm.clearCacheAndReloadPage = jest.fn(() => Promise.resolve());

        await wrapper.vm.activateExtension();

        expect(wrapper.vm.heypanelExtensionService.activateExtension).toHaveBeenCalled();
    ...
    it('deactivateExtension should install and reload the page', async () => {
        ...
        wrapper.vm.heypanelExtensionService.deactivateExtension = jest.fn(() => Promise.resolve());

        wrapper.vm.clearCacheAndReloadPage = jest.fn(() => Promise.resolve());

        await wrapper.vm.deactivateExtension();

        expect(wrapper.vm.heypanelExtensionService.deactivateExtension).toHaveBeenCalled();
        expect(wrapper.vm.isLoading).toBe(false);
    });
