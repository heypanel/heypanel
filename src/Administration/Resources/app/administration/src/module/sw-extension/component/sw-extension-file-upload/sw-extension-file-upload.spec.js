...
describe('src/module/sw-extension/component/sw-extension-file-upload', () => {
    beforeAll(() => {
        HeyPanel.Service().register('heypanelExtensionService', () => {
            return {
    ...
    beforeEach(async () => {
        HeyPanel.Store.get('notification').notifications = {};
        HeyPanel.Store.get('notification').growlNotifications = {};
    });
    ...
    it('should throw an error if the upload goes wrong', async () => {
        ...
        expect(Object.keys(HeyPanel.Store.get('notification').growlNotifications)).toHaveLength(0);
        ...
        await wrapper.vm.$nextTick();
        const growlNotifications = HeyPanel.Store.get('notification').growlNotifications;
