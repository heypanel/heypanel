...
HeyPanel.Component.register('sw-extension-config', () => import('./page/sw-extension-config'));
HeyPanel.Component.register('sw-extension-my-extensions-listing', () => import('./page/sw-extension-my-extensions-listing'));
HeyPanel.Component.register('sw-extension-my-extensions-account', () => import('./page/sw-extension-my-extensions-account'));
HeyPanel.Component.register('sw-extension-my-extensions-index', () => import('./page/sw-extension-my-extensions-index'));
HeyPanel.Component.register('sw-extension-store-landing-page', () => import('./page/sw-extension-store-landing-page'));
...
HeyPanel.Component.register('sw-extension-file-upload', () => import('./component/sw-extension-file-upload'));
HeyPanel.Component.register(
    'sw-extension-permissions-details-modal',
    () => import('./component/sw-extension-permissions-details-modal'),
);
HeyPanel.Component.register('sw-extension-card-base', () => import('./component/sw-extension-card-base'));
...
HeyPanel.Component.register('sw-extension-permissions-modal', () => import('./component/sw-extension-permissions-modal'));
HeyPanel.Component.register('sw-extension-domains-modal', () => import('./component/sw-extension-domains-modal'));
HeyPanel.Component.register(
    'sw-extension-privacy-policy-extensions-modal',
    () => import('./component/sw-extension-privacy-policy-extensions-modal'),
);
HeyPanel.Component.register('sw-extension-deactivation-modal', () => import('./component/sw-extension-deactivation-modal'));
HeyPanel.Component.register('sw-extension-removal-modal', () => import('./component/sw-extension-removal-modal'));
HeyPanel.Component.register('sw-extension-uninstall-modal', () => import('./component/sw-extension-uninstall-modal'));
HeyPanel.Component.register('sw-extension-rating-stars', () => import('./component/sw-ratings/sw-extension-rating-stars'));
HeyPanel.Component.register('sw-extension-ratings-card', () => import('./component/sw-ratings/sw-extension-ratings-card'));
HeyPanel.Component.register(
    'sw-extension-ratings-summary',
    () => import('./component/sw-ratings/sw-extension-ratings-summary'),
);
HeyPanel.Component.register('sw-extension-review', () => import('./component/sw-ratings/sw-extension-review'));
HeyPanel.Component.register(
...
HeyPanel.Component.register('sw-extension-review-reply', () => import('./component/sw-ratings/sw-extension-review-reply'));
HeyPanel.Component.extend(
...
HeyPanel.Component.register('sw-extension-adding-failed', () => import('./component/sw-extension-adding-failed'));
HeyPanel.Component.register('sw-extension-adding-success', () => import('./component/sw-extension-adding-success'));
HeyPanel.Component.register(
    'sw-extension-app-module-error-page',
    () => import('./component/sw-extension-app-module-error-page'),
);
HeyPanel.Component.register('sw-extension-app-module-page', () => import('./page/sw-extension-app-module-page'));
 ...
 * @private
 */
HeyPanel.Module.register('sw-extension', {
    type: 'core',
