...
export default {
    ...
    computed: {
        myExtensions() {
            return HeyPanel.Store.get('heypanelExtensions').myExtensions;
        },
        ...
        isRent() {
            return this.extension?.storeLicense?.variant === this.heypanelExtensionService.EXTENSION_VARIANT_TYPES.RENT;
        },
