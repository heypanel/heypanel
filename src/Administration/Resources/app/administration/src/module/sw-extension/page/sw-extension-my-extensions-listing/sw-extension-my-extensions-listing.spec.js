...
import HeyPanelService from 'src/module/sw-extension/service/heypanel-extension.service';
...
const heypanelService = new HeyPanelService({}, {}, {}, {});
heypanelService.updateExtensionData = jest.fn();
        ...
        }),
        {
            global: {
                ...
                provide: {
                    ...
                    heypanelExtensionService: heypanelService,
                },
            },
...
describe('src/module/sw-extension/page/sw-extension-my-extensions-listing', () => {
    beforeAll(() => {
        HeyPanel.Store.get('heypanelExtensions').setMyExtensions([{ name: 'Test', installedAt: null }]);
    ...
    it('runtime management disabled should be there', async () => {
        HeyPanel.Store.get('context').app.config.settings.disableExtensionManagement = true;
    ...
    it('updateList should call update extensions', async () => {
        ...
        expect(heypanelService.updateExtensionData).toHaveBeenCalled();
    });
    ...
    it('should update the route with the new values from pagination', async () => {
        ...
        HeyPanel.Store.get('heypanelExtensions').setMyExtensions(extensions);
    ...
    it('should show a warning if the APP_URL is not setup correctly', async () => {
        ...
        HeyPanel.Store.get('context').app.config.settings.appUrlReachable = false;
