...
describe('src/module/sw-extension/page/sw-extension-app-module-page/index.js', () => {
    ...
    it('sets the correct heading and source with a regular module', async () => {
        ...
        expect(wrapper.get('iframe#app-content').attributes('src')).toBe('https://heypanel.apps/module1?timestamp=signed');
    });
    ...
    it('sets the correct heading and source with a main module', async () => {
        ...
        expect(wrapper.get('iframe#app-content').attributes('src')).toBe('https://heypanel.apps/login?timestamp=signed');
    });
    ...
    it('should be able to toggle the page smart bar', async () => {
        ...
        HeyPanel.Store.get('extensionSdkModules').addHiddenSmartBar('standardModule');
        await wrapper.vm.$nextTick();
