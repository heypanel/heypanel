...
HeyPanel.Application.addServiceProvider('loginService', () => {
    return {
...
HeyPanel.Application.addServiceProvider('extensionStoreActionService', () => {
    return extensionStoreActionService;
});

HeyPanel.Application.addServiceProvider('heypanelExtensionService', () => {
    return new HeyPanelExtensionService(
        HeyPanel.Service('appModulesService'),
...
HeyPanel.Application.addServiceProvider('extensionErrorService', () => {
...
async function createWrapper(extension) {
    return mount(await wrapTestComponent('sw-extension-card-bought', { sync: true }), {
        global: {
            ...
            mixins: [
                HeyPanel.Mixin.getByName('sw-extension-error'),
            ],
            stubs: {
            ...
            provide: {
                ...
                extensionErrorService: HeyPanel.Service('extensionErrorService'),
                cacheApiService: {},
                shortcutService: {
                    stopEventListener: () => {},
                    startEventListener: () => {},
...
describe('src/module/sw-extension/component/sw-extension-card-bought', () => {
    ...
    it('should display error on install and download attempt when app subscription is expired', async () => {
                        ...
                        errors: [
                            {
                                ...
                                detail: 'The download of the extension is not allowed, please purchase a corresponding license or contact the member service',
                                meta: {
                                    documentationLink: 'https://docs.heypanel.com/en/heypanel-6-en',
                                },
                                status: '500',
        ...
        expect(wrapper.vm.installationFailedError).toEqual({
            title: 'Download not allowed',
            message:
                'The download of the extension is not allowed, please purchase a corresponding license or contact the member service',
            details: null,
            parameters: {
                documentationLink: 'https://docs.heypanel.com/en/heypanel-6-en',
            },
        ...
        expect(wrapper.find('.sw-extension-card-bought__installation-failed-modal p > a').text()).toBe(
            'https://docs.heypanel.com/en/heypanel-6-en',
        );
    });
