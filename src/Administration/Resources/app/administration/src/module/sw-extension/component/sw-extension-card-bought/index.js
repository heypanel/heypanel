...
export default {
    ...
    methods: {
        async changeExtensionStatus() {
            ...
            if (!this.license || this.license.variant !== this.heypanelExtensionService.EXTENSION_VARIANT_TYPES.RENT) {
        ...
        async activateExtension() {
            try {
                ...
                await this.heypanelExtensionService.activateExtension(this.extension.name, this.extension.type);
        ...
        async deactivateExtension() {
            try {
                ...
                await this.heypanelExtensionService.deactivateExtension(this.extension.name, this.extension.type);
                this.extension.active = false;
                this.clearCacheAndReloadPage();
            } catch (e) {
                this.extension.active = true;
        ...
        async installExtension() {
            ...
            try {
                ...
                await this.heypanelExtensionService.installExtension(this.extension.name, this.extension.type);
        ...
        async cancelAndRemoveExtension() {
            try {
                ...
                // by e.g. the heypanel account and the extension already has an expiration date
                if (!this.extension.storeLicense.expirationDate) {
                    await this.heypanelExtensionService.cancelLicense(this.extension.storeLicense.id);
                }

                await this.heypanelExtensionService.removeExtension(this.extension.name, this.extension.type);
