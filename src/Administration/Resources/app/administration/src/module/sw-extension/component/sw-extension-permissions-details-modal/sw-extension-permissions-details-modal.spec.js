...
describe('sw-extension-permissions-details-modal', () => {
    ...
    it('should display the permissions for creating and reading', async () => {
        ...
        expect(categoryHeader.at(0).text()).toBe('entityCategories.question.title');
        ...
        expect(entityLabels.at(0).text()).toBe('entityCategories.question.entities.question');
        expect(entityLabels.at(1).text()).toBe('entityCategories.question.entities.question_visibility');
    ...
    it('should display the permissions for all question permissions', async () => {
        const wrapper = await createWrapper({
            modalTitle: 'Sample Extension Label',
            selectedEntity: 'question',
            permissions: {
