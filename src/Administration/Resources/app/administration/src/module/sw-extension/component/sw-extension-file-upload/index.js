    ...
    methods: {
        ...
        handleUpload(files) {
            ...
            return this.extensionStoreActionService
                .upload(formData)
                .then(() => {
                    HeyPanel.Service('heypanelExtensionService')
                        .updateExtensionData()
                        .then(() => {
        ...
        getUserConfig() {
            return this.userConfigRepository.search(this.userConfigCriteria, HeyPanel.Context.api).then((response) => {
                if (response.length) {
                    this.pluginUploadUserConfig = response.first();
                } else {
                    this.pluginUploadUserConfig = this.userConfigRepository.create(HeyPanel.Context.api);
        ...
        saveConfig(value) {
            ...
            this.userConfigRepository.save(this.pluginUploadUserConfig, HeyPanel.Context.api).then(() => {
                this.getUserConfig();
            });
        },
    },
