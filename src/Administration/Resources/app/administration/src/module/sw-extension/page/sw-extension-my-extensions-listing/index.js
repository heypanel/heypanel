...
export default {
    ...
    inject: ['heypanelExtensionService'],
    ...
    computed: {
        isAppUrlReachable() {
            return HeyPanel.Store.get('context').app.config.settings?.appUrlReachable;
        },

        isLoading() {
            const state = HeyPanel.Store.get('heypanelExtensions');

            return state.myExtensions.loading;
        },

        myExtensions() {
            return HeyPanel.Store.get('heypanelExtensions').myExtensions.data;
        },
    ...
    methods: {
        ...
        updateList() {
            this.heypanelExtensionService.updateExtensionData();
        },
        ...
        updateRouteQuery(query = {}) {
            ...
            if (HeyPanel.Utils.types.isEmpty(routeQuery)) {
