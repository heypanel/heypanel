...
export default {
    ...
    methods: {
        ...
        loadCurrencies() {
            return this.currencyRepository.search(new Criteria(1, 25), HeyPanel.Context.api).then((currencies) => {
                this.currencies = currencies;
            });
        },

        openCustomerTaxModal() {
            this.onToggleCurrencyModal('memberTax');
        },
        ...
        createDataModal() {
            if (this.taxFreeType === 'companyTax' || this.taxFreeType === 'memberTax') {
