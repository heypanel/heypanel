    ...
    methods: {
        ...
        onDeleteCountryStates() {
            ...
            return this.countryStateRepository
                .syncDeleted(countryStateIds, HeyPanel.Context.api)
                .then(() => {
                    this.$refs.countryStateGrid.resetSelection();
                    this.refreshCountryStateList();
                })
        ...
        onAddCountryState() {
            this.currentCountryState = this.countryStateRepository.create(HeyPanel.Context.api);
        },
        ...
        onClickCountryState(item) {
            ...
            const copy = this.countryStateRepository.create(HeyPanel.Context.api, item.id);
            copy._isNew = false;
