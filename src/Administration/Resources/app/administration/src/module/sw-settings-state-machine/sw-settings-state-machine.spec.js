...
HeyPanel.Application.addServiceProvider('privileges', () => {
...
describe('src/module/sw-settings-state-machine/index.js', () => {
    ...
    it('should add privilege mapping', () => {
        const privilegesMappings = HeyPanel.Service('privileges').getPrivilegesMappings();
    ...
    it('should register components', () => {
        const componentRegistry = HeyPanel.Component.getComponentRegistry();
    ...
    it('should register module', () => {
        const module = HeyPanel.Module.getModuleRegistry().get('sw-settings-state-machine');
