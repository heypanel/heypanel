...
HeyPanel.Component.register('sw-settings-tag-list', () => import('./page/sw-settings-tag-list'));
HeyPanel.Component.register('sw-settings-tag-detail-modal', () => import('./component/sw-settings-tag-detail-modal'));
