...
export default {
    ...
    data() {
        return {
            selectedEntity: this.entity ?? 'question',
            selectedAssignment: this.property ?? 'questions',
    ...
    computed: {
        tagDefinition() {
            return HeyPanel.EntityDefinition.get('tag');
        },

        isInheritable() {
            return HeyPanel.EntityDefinition.get(this.selectedEntity)?.properties?.tags?.flags?.inherited === true;
        },
        ...
        entityCriteria() {
            ...
            if (this.selectedEntity === 'question') {
