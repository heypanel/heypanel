...
describe('module/sw-settings-tag/component/sw-settings-tag-detail-assignments', () => {
    ...
    it('should handle adding and removing of assignments including inheritance', async () => {
        ...
        await parentComponent.vm.removeAssignment('questions', '0', { id: '0' });
        await flushPromises();
        ...
        await parentComponent.vm.removeAssignment('questions', '2', { id: '2' });
        await flushPromises();
        ...
        await parentComponent.vm.addAssignment('questions', '0', { id: '0' });
        await flushPromises();
    ...
    it('should search for inheritance of newly added and removed entities if selected only are shown', async () => {
        ...
        await parentComponent.vm.removeAssignment('questions', '0', { id: '0' });
        await parentComponent.vm.addAssignment('questions', '3', { id: '3' });
    ...
    it('should return selected assignments', async () => {
        ...
        await wrapper.setProps({
            toBeAdded: { questions: [{ id: '3' }] },
            toBeDeleted: { questions: [{ id: '2' }] },
        });
