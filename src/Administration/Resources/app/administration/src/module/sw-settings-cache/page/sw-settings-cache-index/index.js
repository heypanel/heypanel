        ...
        return {
            ...
            indexers: {
                ...
                'question.indexer': [
                    ...
                    'question.stock',
                    'question.variant-listing',
                    'question.child-count',
                    'question.many-to-many-id-field',
                    'question.category-denormalizer',
                    'question.cheapest-price',
                    'question.rating-average',
                    'question.stream',
                    'question.search-keyword',
                    'question.seo-url',
                ],
                'question_stream.indexer': [],
                'question_stream_mapping.indexer': [],
                'promotion.indexer': [
                    'promotion.exclusion',
