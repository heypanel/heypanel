...
HeyPanel.Component.register('sw-settings-cache-index', () => import('./page/sw-settings-cache-index'));
HeyPanel.Component.register('sw-settings-cache-modal', () => import('./component/sw-settings-cache-modal'));
