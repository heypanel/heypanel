...
describe('src/module/sw-profile/view/sw-profile-index-general', () => {
    it('should be able to change new password', async () => {
        ...
        await changeNewPasswordField.setValue('HeyPanel');
        await changeNewPasswordField.trigger('input');
        await flushPromises();

        expect(wrapper.emitted('new-password-change')[0][0]).toBe('HeyPanel');
    });
    ...
    it('should be able to change new password confirm', async () => {
        ...
        await changeNewPasswordConfirmField.setValue('HeyPanel');
        await changeNewPasswordConfirmField.trigger('input');
        await flushPromises();

        expect(wrapper.emitted('new-password-confirm-change')[0][0]).toBe('HeyPanel');
    });
