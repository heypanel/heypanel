                ...
                repositoryFactory: {
                    create: (entityName) => {
                        ...
                        return {
                            ...
                            search: () => Promise.resolve(new EntityCollection('', '', HeyPanel.Context.api, null, [], 0)),
                            getSyncChangeset: () => ({
...
describe('src/module/sw-profile/page/sw-profile-index', () => {
    ...
    it('should be able to change new password', async () => {
        ...
        wrapper.vm.onChangeNewPassword('HeyPanel');

        expect(wrapper.vm.newPassword).toBe('HeyPanel');
    });
    ...
    it('should be able to change new password confirm', async () => {
        ...
        wrapper.vm.onChangeNewPasswordConfirm('HeyPanel');

        expect(wrapper.vm.newPasswordConfirm).toBe('HeyPanel');
    });
