...
const { Module, Store, Mixin } = HeyPanel;
...
export default {
    ...
    computed: {
        ...
        adminEsEnable() {
            return HeyPanel.Context.app.adminEsEnable ?? false;
        },
    },
    ...
    methods: {
        ...
        addEventListeners() {
            HeyPanel.Utils.EventBus.on('sw-search-preferences-modal-close', this.getDataSource);
        },

        removeEventListeners() {
            HeyPanel.Utils.EventBus.off('sw-search-preferences-modal-close', this.getDataSource);
        },
