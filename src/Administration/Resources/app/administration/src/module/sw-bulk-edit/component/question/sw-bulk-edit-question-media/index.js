 ...
 */
import template from './sw-bulk-edit-question-media.html.twig';

const { Context, Utils, Mixin } = HeyPanel;
...
export default {
    ...
    computed: {
        ...
        questionMediaRepository() {
            return this.repositoryFactory.create('question_media');
        },
        ...
        mediaDefaultFolderCriteria() {
            ...
            criteria.addFilter(Criteria.equals('entity', 'question'));
    ...
    methods: {
            ...
            media.forEach((item) => {
                this.addMedia(item).catch(({ fileName }) => {
                    this.createNotificationError({
                        message: this.$tc('sw-question.mediaForm.errorMediaItemDuplicated', { fileName }, 0),
                    });
                });
            });
        },
        ...
        addMedia(media) {
            ...
            const newMedia = this.questionMediaRepository.create(HeyPanel.Context.api);
            ...
            this.question.media.add(newMedia);

            return Promise.resolve();
        },

        isExistingMedia(media) {
            return this.question.media.some(({ id, mediaId }) => {
