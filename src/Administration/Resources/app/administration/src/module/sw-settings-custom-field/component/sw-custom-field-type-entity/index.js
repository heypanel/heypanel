...
export default {
    ...
    mounted() {
        this.customEntityRepository.search(new Criteria(), HeyPanel.Context.api).then((result) => {
    ...
    computed: {
        entityTypes() {
            const entityTypes = [
                {
                    label: this.$tc('sw-settings-custom-field.customField.entity.question'),
                    value: 'question',
                },
                {
                ...
                {
                    label: this.$tc('sw-settings-custom-field.customField.entity.member'),
                    value: 'member',
                    config: {
                        labelProperty: [
                            'firstName',
