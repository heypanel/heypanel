...
function provide3DMockOptions() {
    return [
        ...
        [
            {
                fileName: 'smth.glb',
                url: 'http://heypanel.example.com/media/file/2b71335f118c4940b425c55352e69e44/media-1-three-d.glb',
            },
            true,
            true,
        ],
...
describe('module/sw-media/components/sw-media-quickinfo', () => {
    ...
    it('should emit event bus message after save', async () => {
        ...
        const eventBusEmitSpy = jest.spyOn(HeyPanel.Utils.EventBus, 'emit');
