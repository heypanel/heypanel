...
const { Mixin, Context, Utils } = HeyPanel;
...
export default {
    ...
    methods: {
        ...
        fetchSpatialItemConfig() {
            ...
            this.mediaRepository.get(this.item.id, HeyPanel.Context.api).then((entity) => {
        ...
        async onSave() {
            ...
            try {
                ...
                HeyPanel.Utils.EventBus.emit('sw-media-library-item-updated', this.item.id);
            }
        },
