...
HeyPanel.Component.register('sw-settings-customer-group-list', () => import('./page/sw-settings-customer-group-list'));
HeyPanel.Component.register('sw-settings-customer-group-detail', () => import('./page/sw-settings-customer-group-detail'));
