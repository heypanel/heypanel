...
async function createWrapper() {
    return mount(await wrapTestComponent('sw-channel-question-assignment-categories', { sync: true }), {
        global: {
            stubs: {
                'mt-card': {
            ...
            provide: {
                repositoryFactory: {
                    create: (repositoryName) => {
                        ...
                        return {
                            search: () => Promise.resolve(questions),
                        };
                    },
                },
                validationService: {},
...
describe('src/module/sw-channel/component/sw-channel-question-assignment-categories', () => {
    it('should show category tree correctly', async () => {
        ...
        const searchList = wrapper.find('.sw-channel-question-assignment-categories__search-results');
    ...
    it('should show search list when user type in search field', async () => {
        ...
        const tree = wrapper.find('.sw-tree');
        const searchList = wrapper.find('.sw-channel-question-assignment-categories__search-results');
        const searchItems = wrapper.findAll('.sw-channel-question-assignment-categories__search-result');
    ...
    it('should emit selection-change when toggling search item checkbox', async () => {
        ...
        const searchItemSelections = wrapper.findAll('.sw-channel-question-assignment-categories__search-result');
