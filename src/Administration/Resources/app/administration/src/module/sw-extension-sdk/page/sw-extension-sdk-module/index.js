...
export default HeyPanel.Component.wrapComponentConfig({
    ...
    computed: {
        module() {
            return HeyPanel.Store.get('extensionSdkModules').modules.find((module) => module.id === this.id);
        },
        ...
        smartBarButtons() {
            return HeyPanel.Store.get('extensionSdkModules').smartBarButtons.filter(
