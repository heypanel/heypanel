...
HeyPanel.Component.register('sw-settings-snippet-set-list', () => import('./page/sw-settings-snippet-set-list'));
HeyPanel.Component.register('sw-settings-snippet-list', () => import('./page/sw-settings-snippet-list'));
HeyPanel.Component.register('sw-settings-snippet-detail', () => import('./page/sw-settings-snippet-detail'));
HeyPanel.Component.extend(
    'sw-settings-snippet-create',
    'sw-settings-snippet-detail',
    () => import('./page/sw-settings-snippet-create'),
);
HeyPanel.Component.register('sw-settings-snippet-sidebar', () => import('./component/sidebar/sw-settings-snippet-sidebar'));
