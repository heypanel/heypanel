...
HeyPanel.Component.register('sw-settings-number-range-list', () => import('./page/sw-settings-number-range-list'));
HeyPanel.Component.register('sw-settings-number-range-detail', () => import('./page/sw-settings-number-range-detail'));
