...
HeyPanel.Component.register('sw-settings-rule-category-tree', () => import('./component/sw-settings-rule-category-tree'));
HeyPanel.Component.extend(
    'sw-settings-rule-tree-item',
    'sw-tree-item',
    () => import('./component/sw-settings-rule-tree-item'),
);
HeyPanel.Component.extend('sw-settings-rule-tree', 'sw-tree', () => import('./component/sw-settings-rule-tree'));
HeyPanel.Component.register('sw-settings-rule-list', () => import('./page/sw-settings-rule-list'));
HeyPanel.Component.register('sw-settings-rule-detail', () => import('./page/sw-settings-rule-detail'));
HeyPanel.Component.register('sw-settings-rule-detail-base', () => import('./view/sw-settings-rule-detail-base'));
HeyPanel.Component.register(
