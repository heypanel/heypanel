...
const { Component, Mixin, Context } = HeyPanel;
...
export default {
    ...
    methods: {
        ...
        onChangeLanguage(languageId) {
            HeyPanel.Store.get('context').api.languageId = languageId;
        ...
        onDuplicate() {
            return this.onSave().then(() => {
                ...
                return this.ruleRepository.clone(this.rule.id, behaviour, HeyPanel.Context.api).then((duplicatedData) => {
                    this.$router.push({
                        name: 'sw.settings.rule.detail',
