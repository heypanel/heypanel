...
HeyPanel.Component.register('sw-dashboard-statistics', () => import('./component/sw-dashboard-statistics'));
HeyPanel.Component.register('sw-dashboard-index', () => import('./page/sw-dashboard-index'));
 ...
 * @private
 */
HeyPanel.Module.register('sw-dashboard', {
    type: 'core',
    name: 'dashboard',
