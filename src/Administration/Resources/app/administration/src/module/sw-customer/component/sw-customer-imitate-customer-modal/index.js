...
export default {
    ...
    computed: {
        ...
        salesChannelDomainCriteria() {
            ...
            criteria.addFilter(Criteria.equals('salesChannel.typeId', HeyPanel.Defaults.storefrontSalesChannelTypeId));
    ...
    methods: {
        ...
        fetchSalesChannelDomains() {
            this.salesChannelDomainRepository
                .search(this.salesChannelDomainCriteria, HeyPanel.Context.api)
                .then((loadedDomains) => {
