...
const { Mixin, EntityDefinition } = HeyPanel;
    ...
    methods: {
        ...
        onSaveAddress() {
            ...
            if (typeof address === 'undefined' || address === null) {
                address = this.addressRepository.create(HeyPanel.Context.api, this.currentAddress.id);
            }
        ...
        onEditAddress(id) {
            const currentAddress = this.addressRepository.create(HeyPanel.Context.api, id);
