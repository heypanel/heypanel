...
export default {
    ...
    watch: {
        ...
        'customer.accountType'(value) {
            ...
            HeyPanel.Store.get('error').removeApiError(`customer_address.${this.address.id}.company`);
        },
    },
    ...
    methods: {
            ...
            return this.customerValidationService
                ...
                .catch((exception) => {
                    HeyPanel.Store.get('error').addApiError({
                        ...
                        error: new HeyPanelError(exception.response.data.errors[0]),
                    });
                });
        },
        ...
        async onSave() {
            ...
            const context = { ...HeyPanel.Context.api, ...{ languageId } };
        ...
        createErrorMessageForCompanyField() {
            ...
            HeyPanel.Store.get('error').addApiError({
                ...
                error: new HeyPanel.Classes.HeyPanelError({
        ...
        async loadLanguage(salesChannelId) {
            const languageId = HeyPanel.Context.api.languageId;
