...
const swFlowStore = HeyPanel.Store.register('swFlow', {
    state: () => ({
        flow: {
            eventName: '',
    ...
    actions: {
        ...
        updateSequence(params: Partial<Sequence> & { id: string }) {
            ...
            this.flow.sequences = new EntityCollection(sequences.source, sequences.entity, HeyPanel.Context.api, null, [
