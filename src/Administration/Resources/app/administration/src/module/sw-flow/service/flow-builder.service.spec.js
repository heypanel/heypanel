...
describe('module/sw-flow/service/flow-builder.service.js', () => {
    ...
    it('should get available entities correctly based on action name and actions list', async () => {
        const actions = [
            {
                ...
                requirements: ['HeyPanel\\Core\\Framework\\Event\\OrderAware'],
                extensions: [],
            },
            {
            ...
            },
            {
                ...
                requirements: ['HeyPanel\\Core\\Framework\\Event\\MailAware'],
                extensions: [],
            },
        ...
        const allowedAware = [
            'HeyPanel\\Core\\Framework\\Event\\ChannelAware',
    ...
    it('should be able to show member status description', () => {
        const sequence = {
            actionName: 'action.change.member.status',
            config: {},
        };
        const description = service.getActionDescriptions(data, sequence, translator);
        expect(description).toBe('sw-flow.modals.memberStatus.inactive');
    });

    it('should be able to show member affiliate description', () => {
        const sequence = {
            actionName: 'action.add.member.affiliate.and.campaign.code',
            config: {
                affiliateCode: {
                    upsert: 'a',
                    value: 'value',
    ...
    it('should be able to show change member status description', () => {
        const sequence = {
            actionName: 'action.change.member.group',
            config: {
                memberGroupId: '123',
            },
        };
        const description = service.getActionDescriptions(data, sequence, translator);
        expect(description).toBe('member name');
    });

    it('should be able to show member custom field description', () => {
        const sequence = {
            actionName: 'action.set.member.custom.field',
            config: {
