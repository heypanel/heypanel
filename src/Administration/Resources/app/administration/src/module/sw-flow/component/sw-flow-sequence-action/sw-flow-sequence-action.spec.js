...
HeyPanel.Service().register('flowBuilderService', () => {
        ...
        }),
        {
            global: {
                ...
                provide: {
                    ...
                    flowBuilderService: HeyPanel.Service('flowBuilderService'),
                },
            },
...
describe('src/module/sw-flow/component/sw-flow-sequence-action', () => {
    beforeEach(() => {
        ...
        HeyPanel.Store.get('swFlow').setSequences(getSequencesCollection([{ ...sequenceFixture }]));
        HeyPanel.Store.get('swFlow').triggerEvent = {
            data: {
                member: '',
                order: '',
            },
            ...
            extensions: [],
            mailAware: true,
            name: 'checkout.member.login',
            aware: [
                'HeyPanel\\Core\\Framework\\Event\\CustomerAware',
                'HeyPanel\\Core\\Framework\\Event\\OrderAware',
                'HeyPanel\\Core\\Framework\\Event\\MailAware',
            ],
        };
        HeyPanel.Store.get('swFlow').triggerActions = [
            {
    ...
    it('should able to add an action', async () => {
        ...
        const sequencesState = HeyPanel.Store.get('swFlow').sequences;
    ...
    it('should show action list correctly', async () => {
        HeyPanel.Store.get('swFlow').setSequences(getSequencesCollection(sequencesFixture));
    ...
    it('should able to remove action container', async () => {
        ...
        let sequencesState = HeyPanel.Store.get('swFlow').sequences;
        ...
        sequencesState = HeyPanel.Store.get('swFlow').sequences;
    ...
    it('should set error for single select if action name is empty', async () => {
        HeyPanel.Store.get('swFlow').invalidSequences = ['2'];
    ...
    it('should remove error for after select an action name', async () => {
        ...
        let invalidSequences = HeyPanel.Store.get('swFlow').invalidSequences;
        ...
        invalidSequences = HeyPanel.Store.get('swFlow').invalidSequences;
    ...
    it('should correct label in set order state description', async () => {
        HeyPanel.Store.get('swFlow').stateMachineState = [
            {
    ...
    it('should has actions from app flow actions in actions list', async () => {
        ...
        HeyPanel.Store.get('swFlow').setAppActions([
            {
                label: 'Telegram send message',
                name: 'telegram.send.message',
                swIcon: 'regular-envelope',
