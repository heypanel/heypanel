...
export default {
    ...
    computed: {
        ...
        currentLocale() {
            return HeyPanel.Store.get('session').currentLocale;
        },
    ...
    methods: {
        ...
        handleValid(field, val) {
            ...
            if (field.required && !value && typeof value !== 'boolean') {
                ...
                this.errors[field.name] = new HeyPanelError({
        ...
        helpText(field) {
            ...
            return objHelpText[this.currentLocale] ?? objHelpText[HeyPanel.Context.app.fallbackLocale] ?? null;
        },
    },
};
