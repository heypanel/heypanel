...
export const ACTION = Object.freeze({
    ...
    ADD_CUSTOMER_TAG: 'action.add.member.tag',
    REMOVE_TAG: 'action.remove.tag',
    REMOVE_ORDER_TAG: 'action.remove.order.tag',
    REMOVE_CUSTOMER_TAG: 'action.remove.member.tag',
    ...
    SET_CUSTOMER_CUSTOM_FIELD: 'action.set.member.custom.field',
    SET_CUSTOMER_GROUP_CUSTOM_FIELD: 'action.set.member.group.custom.field',
    CHANGE_CUSTOMER_GROUP: 'action.change.member.group',
    CHANGE_CUSTOMER_STATUS: 'action.change.member.status',
    ADD_CUSTOMER_AFFILIATE_AND_CAMPAIGN_CODE: 'action.add.member.affiliate.and.campaign.code',
 ...
 * @sw-package after-sales
 */
export const CUSTOMER_GROUP = 'member';
/**
 * @private
 * @sw-package after-sales
 */
