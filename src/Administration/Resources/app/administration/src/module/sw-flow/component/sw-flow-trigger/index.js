...
const { camelCase, capitalizeString } = HeyPanel.Utils.string;
        ...
        getEventTree(events) {
            ...
            events.forEach((event) => {
                ...
                /*
                 ...
                 For instance, if event name is 'checkout.member.deleted',
                 it's considered that member is checkout's child and deleted is member's child.
                */
