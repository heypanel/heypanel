...
export default {
    ...
    methods: {
        createdComponent() {
            ...
            this.mailTemplate = this.mailTemplateRepository.create(HeyPanel.Context.api, utils.createId());
        },
        ...
        getMailTemplate() {
            return this.mailTemplateRepository
                .get(this.mailTemplate.id, HeyPanel.Context.api, this.mailTemplateCriteria)
                .then((data) => {
