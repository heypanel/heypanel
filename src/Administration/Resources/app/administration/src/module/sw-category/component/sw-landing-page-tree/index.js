...
export default {
    ...
    computed: {
        landingPagesToDelete() {
            return HeyPanel.Store.get('swCategoryDetail').landingPagesToDelete;
        },
    ...
    watch: {
        landingPagesToDelete(value) {
            ...
            HeyPanel.Store.get('swCategoryDetail').landingPagesToDelete = undefined;
        },
    ...
    methods: {
        ...
        duplicateElement(contextItem) {
            ...
            this.landingPageRepository
                .clone(contextItem.id, behavior, HeyPanel.Context.api)
                .then((clone) => {
