...
describe('src/module/sw-category/component/sw-landing-page-tree', () => {
    ...
    beforeEach(async () => {
        ...
        // this is normally set by the heypanel runtime
        // but needed for this unit tests because the component relies on this value.
        oldSystemLanguageId = HeyPanel.Context.api.systemLanguageId;
        HeyPanel.Context.api.systemLanguageId = '1a2b3c';
    });

    afterEach(async () => {
        HeyPanel.Context.api.systemLanguageId = oldSystemLanguageId;
    });
