import type { Entity } from '@heypanel-ag/meteor-admin-sdk/es/_internals/data/Entity';
import type CriteriaType from '@heypanel-ag/meteor-admin-sdk/es/data/Criteria';
 ...
 */
const swCategoryDetailStore = HeyPanel.Store.register({
    id: 'swCategoryDetail',
