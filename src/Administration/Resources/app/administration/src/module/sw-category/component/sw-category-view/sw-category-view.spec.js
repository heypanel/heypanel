...
async function createWrapper(categoryType) {
    ...
    HeyPanel.Store.get('swCategoryDetail').category = {
        id: categoryIdMock,
    };
    HeyPanel.Store.get('swCategoryDetail').isCategoryColumn = true;
...
describe('src/module/sw-category/component/sw-category-view', () => {
    ...
    function checkProductTab(questionTab) {
        expect(questionTab.props()).toStrictEqual({
            route: { name: 'sw.category.detail.questions' },
            title: 'sw-category.view.questions',
        });
        expect(questionTab.text()).toBe('sw-category.view.questions');
    }
    ...
    it('should display the tabs for the `page` category type', async () => {
        ...
        const questionTab = wrapper.getComponent('.sw-category-detail__tab-questions');
        checkProductTab(questionTab);
    ...
    it('should display the tabs for the `folder` category type', async () => {
        ...
        const questionTab = wrapper.getComponent('.sw-category-detail__tab-questions');
        expect(questionTab.isVisible()).toBe(false);
