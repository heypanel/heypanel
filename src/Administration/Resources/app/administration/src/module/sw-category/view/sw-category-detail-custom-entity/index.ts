...
export default HeyPanel.Component.wrapComponentConfig({
    ...
    computed: {
        ...
        category(): Entity<'category'> | null {
            ...
            return HeyPanel.Store.get('swCategoryDetail').category as Entity<'category'> | null;
        },
