...
export default {
    ...
    computed: {
        categoriesToDelete() {
            return HeyPanel.Store.get('swCategoryDetail').categoriesToDelete;
        },
        ...
        disableContextMenu() {
            ...
            return this.currentLanguageId !== HeyPanel.Context.api.systemLanguageId;
        },
    ...
    watch: {
        categoriesToDelete(value) {
            ...
            HeyPanel.Store.get('swCategoryDetail').categoriesToDelete = undefined;
        },
    ...
    methods: {
            ...
            this.loadRootCategories().then(() => {
                ...
                parentIds.forEach((id) => {
                    const promise = this.categoryRepository
                        .get(id, HeyPanel.Context.api, this.criteriaWithChildren)
                        .then((result) => {
                            this.addCategories([
                                result,
                                ...result.children,
        ...
        onUpdatePositions: HeyPanel.Utils.debounce(function onUpdatePositions({ draggedItem, oldParentId, newParentId }) {
        ...
        syncProducts(categoryId) {
            ...
            return this.questionRepository.iterateIds(criteria, this.indexProducts);
        },

        indexProducts(ids) {
            const headers = this.questionRepository.buildHeaders();

            const initContainer = HeyPanel.Application.getContainer('init');
            const httpClient = initContainer.httpClient;

            return httpClient.post('/_action/index-questions', { ids }, { headers });
        },
        ...
        async deleteCheckedItems(checkedItems) {
            ...
            await this.categoryRepository.syncDeleted(ids, HeyPanel.Context.api);
        ...
        syncSiblings({ parentId }) {
            ...
            return this.categoryRepository
                ...
                .then(() => {
                    this.categoryRepository.get(parentId, HeyPanel.Context.api, this.criteria).then((parent) => {
