...
const { debounce, get, flow } = HeyPanel.Utils;
...
export default {
    ...
    computed: {
        ...
        currentEntity() {
            ...
            let actualDefinition = HeyPanel.EntityDefinition.get(this.entityType);
            ...
            pathParts.forEach((propertyName) => {
                ...
                entityFound = HeyPanel.EntityDefinition.has(entity);

                if (entityFound) {
                    actualDefinition = HeyPanel.EntityDefinition.get(entity);
                }
            });
        ...
        options() {
            ...
            if (isCustomField) {
                ...
                definition = HeyPanel.EntityDefinition.get(this.currentEntity);
            }
    ...
    methods: {
        ...
        processTranslations({ definition, options, properties, path }) {
            ...
            const translationDefinition = HeyPanel.EntityDefinition.get(translationProperty.entity);
        ...
        processTransactions({ definition, options, properties, path }) {
            ...
            const transactionDefinition = HeyPanel.EntityDefinition.get(transactionsProperty.entity);
        ...
        processDeliveries({ definition, options, properties, path }) {
            ...
            const deliveryDefinition = HeyPanel.EntityDefinition.get(deliveryProperty.entity);
