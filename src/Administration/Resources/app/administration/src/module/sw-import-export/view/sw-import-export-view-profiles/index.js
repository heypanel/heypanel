...
export default {
    ...
    computed: {
        ...
        isNotSystemLanguage() {
            return HeyPanel.Context.api.systemLanguageId !== HeyPanel.Context.api.languageId;
        },
    ...
    methods: {
        ...
        onDuplicateProfile(item) {
            ...
            return this.profileRepository
                .clone(item.id, behavior, HeyPanel.Context.api)
                .then((clone) => {
                    const criteria = new Criteria(1, 25);
        ...
        saveSelectedProfile() {
            this.isLoading = true;
            return this.profileRepository
                .save(this.selectedProfile, HeyPanel.Context.api)
                .then(() => {
                    this.showProfileEditModal = false;
                    this.selectedProfile = null;
