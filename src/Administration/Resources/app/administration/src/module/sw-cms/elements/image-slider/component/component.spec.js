...
HeyPanel.Context.api.assetsPath = MOCK_ASSET_PATH;
...
const sliderItemsConfigMock = [
    ...
    {
        mediaId: '3',
        mediaUrl: 'http://heypanel.com/image3.jpg',
    },
];
...
const sliderItemsDataMock = [
    ...
    },
    {
        media: {
            id: '3',
            url: 'http://heypanel.com/image3.jpg',
        },
    },
];
...
describe('src/module/sw-cms/elements/image-slider/component', () => {
    ...
    it('setSliderArrowItem should work correctly', async () => {
        ...
        expect(wrapper.vm.imgSrc).toBe('http://heypanel.com/image1.jpg');
        ...
        expect(wrapper.vm.imgSrc).toBe('http://heypanel.com/image3.jpg');
        ...
        expect(wrapper.vm.imgSrc).toBe('http://heypanel.com/image2.jpg');
    });
