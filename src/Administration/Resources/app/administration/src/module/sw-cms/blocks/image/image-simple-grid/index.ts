 ...
 */
HeyPanel.Component.register('sw-cms-preview-image-simple-grid', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-block-image-simple-grid', () => import('./component'));
