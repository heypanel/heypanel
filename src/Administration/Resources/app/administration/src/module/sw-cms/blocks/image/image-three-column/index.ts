 ...
 */
HeyPanel.Component.register('sw-cms-preview-image-three-column', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-block-image-three-column', () => import('./component'));
