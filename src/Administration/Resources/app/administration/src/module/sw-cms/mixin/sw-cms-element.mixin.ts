    ...
    defineComponent({
        ...
        computed: {
            ...
            category(): EntitySchema.Entities['category'] {
                ...
                return HeyPanel.Store.get('swCategoryDetail')?.category as EntitySchema.Entities['category'];
            },
        },
        ...
        methods: {
            ...
            getDefaultTranslations(entity: Entity) {
                return entity.translations.find((translation) => {
                    return translation.languageId === HeyPanel.Context.api.systemLanguageId;
                });
            },
        },
    }),
