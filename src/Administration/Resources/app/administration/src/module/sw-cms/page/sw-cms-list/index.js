...
export default {
    ...
    methods: {
        ...
        showDefaultLayoutContextMenu(cmsPage) {
            ...
            if (cmsPage.type === 'question_list') {
                return this.defaultCategoryId !== cmsPage.id;
            }

            if (cmsPage.type === 'question_detail') {
        ...
        async getDefaultLayouts() {
            ...
            this.defaultProductId = response['core.cms.default_question_cms_page'];
        },
        ...
        onDuplicateCmsPage(page, behavior = { overwrites: {} }) {
            ...
            this.isLoading = true;
            this.pageRepository
                .clone(page.id, behavior, HeyPanel.Context.api)
                .then(() => {
                    this.resetList();
                    this.isLoading = false;
                })
        ...
        saveCmsPage(page, context = HeyPanel.Context.api) {
            this.isLoading = true;
            return this.pageRepository
                .save(page, context)
                .then(() => {
        ...
        getPageCount(page) {
            const pageCount = this.getPageCategoryCount(page);
        ...
        getPages(page) {
            return [
                ...
                ...page.questions.map((item) => item.name),
            ];
        },
        ...
        optionContextDeleteDisabled(page) {
            return this.getPageCategoryCount(page) > 0 || !this.acl.can('cms.deleter');
        },
    },
};
