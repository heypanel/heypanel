...
const questionID = 'TEST-PRODUCT-ID';
                    ...
                    systemConfigApiService: {
                        getValues: () => {
                            return {
                                ...
                                'core.cms.default_question_cms_page': '1a',
                            };
                        },
                    },
                    repositoryFactory: {
...
describe('module/sw-cms/page/sw-cms-detail', () => {
    beforeEach(async () => {
        HeyPanel.Store.get('cmsPage').$reset();
    ...
    it('should have warning message if there are more than 1 question page element in question page layout', async () => {
        const wrapper = await createWrapper();
        await flushPromises();
    ...
    it('should get preview entity for categories', async () => {
        ...
        const State = HeyPanel.Store._rootState.state.value.cmsPage;
        ...
        expect(State.currentDemoProducts).toMatchObject([{ id: questionID }]);
    ...
    it('should get preview entity for questions', async () => {
        const wrapper = await createWrapper();
        await flushPromises();
        ...
        expect(State.currentDemoEntity).toMatchObject({ id: questionID });
        expect(State.currentDemoProducts).toEqual([]);
    });
    ...
    it('should set the currentPageType in the cmsPage', async () => {
        ...
        let State = HeyPanel.Store._rootState.state.value.cmsPage;
        ...
        State = HeyPanel.Store._rootState.state.value.cmsPage;
