 ...
 */
HeyPanel.Component.register('sw-cms-preview-image-text-gallery', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-block-image-text-gallery', () => import('./component'));
