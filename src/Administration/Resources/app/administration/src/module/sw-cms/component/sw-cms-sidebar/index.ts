...
export default HeyPanel.Component.wrapComponentConfig({
    ...
    computed: {
        ...
        cmsBlocks() {
            const currentPageType = HeyPanel.Store.get('cmsPage').currentPageType;
        ...
        tooltipDisabled() {
            return {
                ...
                disabled: this.page.type !== 'question_detail',
            };
        },

        demoCriteria() {
            if (this.demoEntity === 'question') {
        ...
        showDefaultLayoutSelection() {
            ...
            if (this.page.type === 'question_list' || this.page.type === 'question_detail') {
    ...
    methods: {
        ...
        isDisabledPageType(pageType: PageType) {
            ...
            return pageType.name === 'question_detail' || pageType.name.includes('custom_entity_');
        },

        openSectionSettings(sectionIndex: number) {
            HeyPanel.Store.get('cmsPage').setSection(this.page.sections![sectionIndex]);
        ...
        onSectionDelete(sectionId: string) {
            HeyPanel.Store.get('cmsPage').removeSelectedSection();
        ...
        onBlockDelete(block: Entity<'cms_block'>, section: Entity<'cms_section'> | null) {
            ...
            if (this.selectedBlock && this.selectedBlock.id === block.id) {
                HeyPanel.Store.get('cmsPage').removeSelectedBlock();
            }
