...
describe('module/sw-cms/component/sw-cms-missing-element-modal', () => {
    ...
    it('should expose two missing elements', async () => {
        ...
        expect(title.text()).toBe(
            ...
            'sw-cms.components.cmsMissingElementModal.title{"element":"sw-cms.elements.buyBox.label, sw-cms.elements.questionDescriptionReviews.label"}',
        );
    });
    ...
    it('should expose three missing elements', async () => {
        ...
        expect(title.text()).toBe(
            // eslint-disable-next-line max-len
            'sw-cms.components.cmsMissingElementModal.title{"element":"sw-cms.elements.buyBox.label, sw-cms.elements.questionDescriptionReviews.label, sw-cms.elements.crossSelling.label"}',
        );
    });
});
