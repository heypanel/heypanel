 ...
 */
HeyPanel.Component.register('sw-cms-preview-image-four-column', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-block-image-four-column', () => import('./component'));
