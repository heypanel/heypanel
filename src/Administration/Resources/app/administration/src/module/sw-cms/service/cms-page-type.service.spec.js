...
const expectedTypes = {
    ...
    question_list: {
        ...
        title: 'sw-cms.detail.label.pageType.questionList',
        class: ['sw-cms-create-wizard__page-type-question-list'],
        hideInList: false,
    },
    question_detail: {
        name: 'question_detail',
        icon: 'regular-tag',
        title: 'sw-cms.detail.label.pageType.questionDetail',
        class: ['sw-cms-create-wizard__page-type-question-detail'],
        hideInList: false,
    },
};
...
describe('module/sw-cms/service/cms-page-type.service.ts', () => {
    ...
    beforeAll(() => {
        HeyPanel.Service().register('cmsPageTypeService', () => {
            return new CmsPageTypeService();
        });

        cmsPageTypeService = HeyPanel.Service().get('cmsPageTypeService');
