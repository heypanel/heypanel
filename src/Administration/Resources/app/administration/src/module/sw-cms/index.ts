...
HeyPanel.Component.register('sw-cms-list', () => import('./page/sw-cms-list'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-detail', () => import('./page/sw-cms-detail'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.extend('sw-cms-create', 'sw-cms-detail', () => import('./page/sw-cms-create'));

// eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
HeyPanel.Module.register('sw-cms', {
    type: 'core',
    name: 'cms',
