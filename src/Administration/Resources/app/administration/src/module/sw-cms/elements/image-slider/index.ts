 ...
 */
HeyPanel.Component.register('sw-cms-el-preview-image-slider', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-el-config-image-slider', () => import('./config'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-el-image-slider', () => import('./component'));
