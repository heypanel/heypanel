...
describe('module/sw-cms/component/sw-cms-list-item', () => {
    ...
    const previewMediaDataProvider = [
        ...
        [
            ...
            {
                'background-image': 'url(administration/administration/static/img/cms/default_preview_question_list.jpg)',
            },
        ],
        [
            'with defaultItemLayoutAssetBackground',
            {
                ...
                sections: [
                    {
                        type: 'question_listing',
                    },
                ],
            },
            {
                'background-image':
                    'url(administration/administration/static/img/cms/preview_question_list_question_listing.png)',
                'background-size': 'cover',
            },
        ],
        [
