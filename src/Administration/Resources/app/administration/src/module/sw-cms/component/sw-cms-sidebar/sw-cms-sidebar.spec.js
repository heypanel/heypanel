...
const { EntityCollection, Entity } = HeyPanel.Data;
...
describe('module/sw-cms/component/sw-cms-sidebar', () => {
    ...
    const showDefaultLayoutSelectionDataProvider = [
        [
            'show the default layout selection, when "question_list" page is no default layout',
            {
                pageType: 'question_list',
        ...
        [
            'show the default layout selection, when "question_detail" page is no default layout',
            {
        ...
        [
            'not show the default layout selection, when "question_list" page is already a default layout',
            {
                pageType: 'question_list',
        ...
        [
            'not show the default layout selection, when "question_detail" page is already a default layout',
            {
                pageType: 'question_detail',
                isDefaultLayout: true,
                expectedSelectionCount: 0,
    ...
    it.each(defaultLayoutSelectionDataProvider)(
        ...
        async (caseName, testedPrivileges) => {
            const wrapper = await createWrapper({ cmsBlockRegistry: null }, 'question_list', testedPrivileges);
    ...
    it('should show tooltip and disable layout type select when page type is question detail', async () => {
        const wrapper = await createWrapper();
    ...
    it('should hide tooltip and enable layout type select when page type is not question detail', async () => {
        const wrapper = await createWrapper();
        ...
        const questionPageOption = wrapper.findComponent('[data-testid="mt-select-option--question_detail"]');

        expect(layoutTypeSelect.props().disabled).toBe(false);
        expect(questionPageOption.props().disabled).toBe(true);
    });
    ...
    it('should filter blocks based on pageType, category and visibility', async () => {
        const wrapper = await createWrapper({
            cmsBlockRegistry: {
                ...
                question_list_hidden_block: {
                    name: 'question_list_hidden_block',
                    category: 'text',
                    hidden: true,
                },
                question_list_different_category: {
                    name: 'question_list_different_category',
                    category: 'question',
                    hidden: false,
                },
            },
        ...
        expect(wrapper.vm.cmsBlocksBySelectedBlockCategory.map((block) => block.name)).toStrictEqual(['question_list_block']);
    });
