...
describe('module/sw-cms/service/cms.service.spec.js', () => {
    ...
    const enrichData = {
        'entity-media-0': new HeyPanel.Data.EntityCollection(
            '/media',
            'media',
            null,
            null,
        ...
        'entity-media-1': new HeyPanel.Data.EntityCollection(
            '/media',
            'media',
            null,
            null,
    ...
    describe('collect', () => {
        it('adds multiple entity data when cms element defaultConfig properties have the same entity', async () => {
            ...
            const entityMedia2Criteria = new HeyPanel.Data.Criteria(1, 25);
            entityMedia2Criteria.setIds([5]);

            const entityMedia3Criteria = new HeyPanel.Data.Criteria(1, 25);
        ...
        it('uses given search criteria of cms element', async () => {
            const criteria = new HeyPanel.Data.Criteria(1, 10);
            criteria.setIds(['123']);
            // cms element components call the initElementConfig() function from cms-service mixin
            // to add the defaultConfig properties to the config root level
            const element = {
    ...
    describe('getEntityMappingTypes', () => {
        const entityDefinition = HeyPanel.EntityDefinition;
        ...
        it('should add custom fields to mapping types for an entity', async () => {
            const mappings = {};
            await cmsService.addCustomFieldsToMappingTypes('question', mappings);

            expect(mappings).toEqual({
                string: [
                    'question.customFields.custom_text_field',
                    'question.customFields.custom_textarea_field',
                    'question.customFields.custom_datetime_field',
                ],
            });
        });
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        'category.questionStream.categories',
                    ],
                ],
            ].forEach(
                ([
    ...
    describe('getPropertyByMappingPath', () => {
        it('returns the property of a given entity by path', async () => {
            const entity = new Entity('test', 'question_manufacturer', {
    ...
    describe('getCollectFunction', () => {
        ...
        it('flattens array entityData values', async () => {
            ...
            const entityCriteria = new HeyPanel.Data.Criteria(1, 25);
