...
const sliderItemsConfigMock = [
    {
        mediaId: '1',
        mediaUrl: 'http://heypanel.com/image1.jpg',
    },
    {
        mediaId: '2',
        mediaUrl: 'http://heypanel.com/image2.jpg',
    },
];
...
const sliderItemsDataMock = [
    {
        media: {
            id: '1',
            url: 'http://heypanel.com/image1.jpg',
        },
    },
    {
        media: {
            id: '2',
            url: 'http://heypanel.com/image2.jpg',
        },
    },
];
...
describe('src/module/sw-cms/elements/image-gallery/component', () => {
    ...
    it('should map to question media if the component is in a question page', async () => {
        HeyPanel.Store.get('cmsPage').setCurrentPage({
        ...
        expect(wrapper.vm.element.config.sliderItems.value).toBe('question.media');
    });

    it('should not initially map to question media if the component is sliderItems data exists', async () => {
        const wrapper = await createWrapper({
            element: {
                config: {
                    sliderItems: {
