 ...
 */
HeyPanel.Component.register('sw-cms-el-preview-image-gallery', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-el-config-image-gallery', () => import('./config'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-el-image-gallery', () => import('./component'));
