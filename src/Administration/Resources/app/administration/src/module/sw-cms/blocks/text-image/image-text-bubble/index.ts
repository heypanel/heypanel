 ...
 */
HeyPanel.Component.register('sw-cms-preview-image-text-bubble', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyPanel.Component.register('sw-cms-block-image-text-bubble', () => import('./component'));
