...
HeyPanel.Component.register('sw-mail-template-list', () => import('./component/sw-mail-template-list'));
HeyPanel.Component.register('sw-mail-header-footer-list', () => import('./component/sw-mail-header-footer-list'));
HeyPanel.Component.register('sw-mail-template-detail', () => import('./page/sw-mail-template-detail'));
HeyPanel.Component.extend(
    'sw-mail-template-create',
    'sw-mail-template-detail',
    () => import('./page/sw-mail-template-create'),
);
HeyPanel.Component.register('sw-mail-template-index', () => import('./page/sw-mail-template-index'));
HeyPanel.Component.register('sw-mail-header-footer-detail', () => import('./page/sw-mail-header-footer-detail'));
HeyPanel.Component.extend(
