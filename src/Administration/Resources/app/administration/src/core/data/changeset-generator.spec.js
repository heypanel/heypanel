    ...
    beforeAll(() => {
        Object.entries(entitySchemaMock).forEach(
            ([
                ...
                HeyPanel.EntityDefinition.add(entityName, entityDefinition);
            },
        );
    });

    it('should generate no changes', async () => {
        const testEntity = entityFactory.create('question_manufacturer');
    ...
    [
        {
            ...
            entityChanges: { name: 'HeyPanel AG' },
            expected: { name: 'HeyPanel AG' },
        },
        {
