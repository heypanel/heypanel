 ...
 *
 * @module core/data/HeyPanelError
 */
 ...
 * @memberOf module:core/data/HeyPanelError
 */
// eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
export default class HeyPanelError {
    ...
    constructor({
        ...
        if (typeof code !== 'string' || code === '') {
            throw new Error('[HeyPanelError] can not identify error by code');
        }
