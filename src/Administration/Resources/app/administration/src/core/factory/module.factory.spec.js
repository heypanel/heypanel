...
const { Module, Application } = HeyPanel;
...
describe('core/factory/module.factory.js', () => {
    ...
    it('should be possible to register a module with multiple navigation entries', () => {
        ...
        expect(externalLinkNavigation.link).toBe('http://de.heypanel.com');
    });
    ...
    it('should add settings item if feature flag is active', () => {
        ...
        expect(HeyPanel.Store.get('settingsItems').settingsGroups).toEqual(expectedSettingsItem);
    });
    ...
    it('should not add settings item if feature flag is deactivated', () => {
        ...
        expect(HeyPanel.Store.get('settingsItems').settingsGroups).toEqual({});
    });
