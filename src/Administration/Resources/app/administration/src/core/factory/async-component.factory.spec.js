...
function createComponentMatrix(components) {
    ...
    // create cartesian question of all component possibilities
    ...
    const result = cartesianProduct(possibilitiesForComponents).map((question) => {
        return question.reduce((acc, { key, value }) => {
            acc[key] = value;
            return acc;
        }, {});
    });
