...
export default function createRouter(Router, View, moduleFactory, LoginService) {
    ...
    function addGlobalNavigationGuard(router) {
        ...
        router.beforeEach((to) => {
            ...
            const tokenHandler = new HeyPanel.Helper.RefreshTokenHelper();
            ...
            if (to.meta.privilege && !HeyPanel.Service('acl').can(to.meta.privilege)) {
    ...
    function convertRouteComponentToViewComponent(route) {
        const hasOwnProperty = HeyPanel.Utils.object.hasOwnProperty;
    ...
    function getViewComponent(componentName) {
        return HeyPanel.Application.view.getComponentForRoute(componentName);
    }

    function getAssetPath() {
        return HeyPanel.Context.api.assetsPath;
    }
