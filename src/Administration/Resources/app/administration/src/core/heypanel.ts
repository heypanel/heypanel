...
class HeyPanelClass implements CustomHeyPanelProperties {
    /**
     * @private
     */
    ...
    public Component = {
        ...
        registerOverrideComponent: (component: DefineComponent<unknown, unknown, unknown>) => {
            HeyPanelClass.#overrideComponents.value.push(component);
        },
        /**
         * @experimental stableVersion:v6.8.0 feature:ADMIN_COMPOSITION_API_EXTENSION_SYSTEM
         */
        getOverrideComponents: () => {
            return HeyPanelClass.#overrideComponents.value;
        },
    };
    ...
    public Defaults = {
        ...
        questionComparisonTypeId: 'ed535e5722134ac1aa6524f73e26881b',
    ...
    public get Snippet() {
        return {
            ...
            ...HeyPanel.Application.view.i18n.global,
            // @ts-expect-error - type is currently not available
            tc: HeyPanel.Application.view.i18n.global.t,
        };
    }
...
const HeyPanelInstance = new HeyPanelClass();

// Freeze InAppPurchase to prevent modifications
Object.defineProperty(HeyPanelInstance, 'InAppPurchase', { configurable: false, writable: false });

// eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
export { HeyPanelClass, HeyPanelInstance };
