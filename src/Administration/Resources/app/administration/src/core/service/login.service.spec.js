...
describe('core/service/login.service.js', () => {
    beforeAll(async () => {
        ...
        HeyPanel.Service().register('userActivityService', () => {
            return {
                getLastUserActivity: () => {
    ...
    beforeEach(() => {
        ...
        HeyPanel.Application.view.router = undefined;
    });
    ...
    it('should login and return the bearer token', async () => {
        ...
        const auth = await loginService.loginByUsername('admin', 'heypanel');
    ...
    it('should get a new token', async () => {
        ...
        await loginService.loginByUsername('admin', 'heypanel');
    ...
    it('should set logout refresh storage key correctly', async () => {
        // Mock Router
        HeyPanel.Application.view.router = {
            currentRoute: {
                value: {
