...
function getTagApiService() {
    ...
    const loginService = createLoginService(client, HeyPanel.Context.api);
    ...
    it('is handling merge correctly', async () => {
        ...
        const tagRepositoryMock = {
            ...
            save: jest.fn((tag) => {
                ...
                if (bulkMergeProgress.currentAssignment === 'questions' && bulkMergeProgress.progress === 0) {
                    // eslint-disable-next-line jest/no-conditional-expect
                    expect(tag.questions).toEqual(
                ...
                if (bulkMergeProgress.currentAssignment === 'questions') {
                    // eslint-disable-next-line jest/no-conditional-expect
                    expect(tag.questions).toEqual(
                        [
                            200,
        ...
        const generalRepositoryMock = {
            searchIds: jest.fn((criteria) => {
                ...
                if (bulkMergeProgress.currentAssignment === 'questions' && criteria.page === 1) {
