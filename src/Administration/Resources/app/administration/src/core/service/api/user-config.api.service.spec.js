...
function newUserConfigService(client) {
    return new UserConfigService(client, createLoginService(client, HeyPanel.Context.api));
}
...
describe('userConfigService', () => {
    ...
    it('returns undefined on error and logs the error', async () => {
        ...
        const consoleSpy = jest.spyOn(HeyPanel.Utils.debug, 'error').mockImplementation(() => {});
