...
import { handleFactory, send } from '@heypanel-ag/meteor-admin-sdk/es/channel';
import SerializerFactory from '@heypanel-ag/meteor-admin-sdk/es/_internals/serializer';
...
describe('core/service/extension-api-data.service.ts', () => {
    it('should keep functions on entity', async () => {
        const entity = new Entity(HeyPanel.Utils.createId(), 'jest', {
            name: 'jest',
        });
    ...
    it('should update entity', async () => {
        const entity = new Entity(HeyPanel.Utils.createId(), 'jestupdate', {
            name: 'beforeupdate',
        });
        ...
        jest.spyOn(window, 'addEventListener').mockImplementationOnce((event, handler) => {
            const e = new Entity(HeyPanel.Utils.createId(), 'jestupdate', {
                name: 'beforeupdate',
            });
            ...
            const data = {
                ...
                _callbackId: HeyPanel.Utils.createId(),
            };
    ...
    it('should update collection', async () => {
        ...
        collection.add(
            new Entity(HeyPanel.Utils.createId(), 'jest', {
                id: 1,
                name: 'jest1',
            }),
        );
    ...
    it('should deepClone with Entities', async () => {
        const originalValue = {
            name: 'HeyPanel',
            age: 21,
            question: new Entity('foo', 'question', {
                name: 'T-Shirt',
                price: 10,
            ...
            mediaCollection: new EntityCollection(
                ...
                [
                    new Entity('image1', 'media', {
                        url: 'https://heypanel.com/image1.jpg',
                        tags: new EntityCollection('image1/tags', 'tag', {}, null, [
                            ...
                            new Entity('tag3', 'tag', {
                                name: 'HeyPanel Community',
                            }),
                        ]),
                    }),
                    new Entity('image2', 'media', {
                        url: 'https://heypanel.com/image2.jpg',
        ...
        expect(clonedValue.question).not.toBe(originalValue.question);
    ...
    it.each([
        ...
        if (env === 'prod') {
            ...
            process.env = 'prod';
            HeyPanel.Utils.debug.warn = mock;
        } else {
            HeyPanel.Utils.debug.error = mock;
        }
