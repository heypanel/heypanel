...
import '@heypanel-ag/meteor-admin-sdk';
...
import type HeyPanelDiscountCampaignService from './app/service/discount-campaign.service';
...
import type { HeyPanelExtensionsStore } from './module/sw-extension/store/extensions.store';
...
declare global {
    ...
    interface CustomHeyPanelProperties {}

    /**
     * Make the HeyPanel object globally available
     */
    const HeyPanel: HeyPanelClass & CustomHeyPanelProperties;
    ...
    interface Window {
        HeyPanel: HeyPanelClass & CustomHeyPanelProperties;
        _features_: {
    ...
    interface ServiceContainer extends SubContainer<'service'> {
        ...
        questionStreamConditionService: $TSFixMe;
        ...
        heypanelDiscountCampaignService: HeyPanelDiscountCampaignService;
    ...
    interface PiniaRootState {
        ...
        heypanelExtensions: HeyPanelExtensionsStore;
    ...
    /**
     * @see HeyPanel\Core\Framework\Api\EventListener\ErrorResponseFactory
     */
    interface HeyPanelHttpError {
        code: string;
        status: string;
        title: string;
        detail: string;
        meta?: {
            ...
            parameters?: object;
            previous?: HeyPanelHttpError;
        };
        trace?: { [key: string]: string };
    }

    interface HeyPanelErrorMeta {
        parameters: {
            dependency: string;
    ...
    interface HeyPanelError {
        code: string;
        meta: HeyPanelErrorMeta;
    }

    interface HeyPanelApiError {
        response: {
            data: {
                errors: HeyPanelError[];
            };
        };
    }

    interface StoreApiException extends HeyPanelHttpError {
        meta?: HeyPanelHttpError['meta'] & {
...
declare module 'axios' {
    interface AxiosRequestConfig {
        // adds the heypanel API version to the RequestConfig
        version?: number;
    }
}
