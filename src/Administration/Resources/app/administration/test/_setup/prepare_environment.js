...
import {
    ...
    MtToast,
    MtTextEditor,
} from '@heypanel-ag/meteor-component-library';
...
// Add services
HeyPanel.Service().register('acl', () => aclService);
HeyPanel.Service().register('feature', () => feature);
HeyPanel.Feature = HeyPanel.Service('feature');
HeyPanel.Service().register('repositoryFactory', () => repositoryFactory);

// Provide all services
HeyPanel.Service().list().forEach(serviceKey => {
    config.global.provide[serviceKey] = HeyPanel.Service(serviceKey);
});

// Set important functions for HeyPanel Core
...
// Prepare Context
HeyPanel.Store.get('context').api.installationPath = 'installationPath';
HeyPanel.Store.get('context').api.apiPath = '/api';
HeyPanel.Store.get('context').api.apiResourcePath = '/api/v3';
HeyPanel.Store.get('context').api.assetsPath = '';
HeyPanel.Store.get('context').api.languageId = '2fbb5fe2e29a4d70aa5854ce7ce3e20b';
HeyPanel.Store.get('context').api.inheritance = false;
HeyPanel.Store.get('context').api.systemLanguageId = '2fbb5fe2e29a4d70aa5854ce7ce3e20b';
HeyPanel.Store.get('context').api.liveVersionId = '0fa91ce3e96a4bc2be4bd9ce752c3425';
HeyPanel.Context.api.authToken = {
...
const directiveRegistry = HeyPanel.Directive.getDirectiveRegistry();
...
global.window.startApplication = ()=>{};
