...
module.exports = {
    ...
    transformIgnorePatterns: [
        '/node_modules/(?!(@heypanel-ag/meteor-component-library|@heypanel-ag/meteor-icon-kit|uuidv7|other)/)',
    ],

    moduleNameMapper: {
        '^test(.*)$': '<rootDir>/test$1',
        '^\@heypanel-ag\/admin-extension-sdk\/es\/(.*)': '<rootDir>/node_modules/@heypanel-ag/admin-extension-sdk/umd/$1',
        '^\@heypanel-ag\/meteor-admin-sdk\/es\/(.*)': '<rootDir>/node_modules/@heypanel-ag/meteor-admin-sdk/umd/$1',
        '^@heypanel-ag/meteor-component-library$': '<rootDir>/node_modules/@heypanel-ag/meteor-component-library/dist/common/index.js',
        '^lodash-es$': 'lodash',
    ...
    reporters: isCi ? [
        ...
        ['jest-junit', {
            suiteName: 'HeyPanel 6 Unit Tests',
