...
const getAsyncExpressionName = (node) => {
    // HeyPanel.Component.build
    if (node.callee?.object?.object?.name === 'HeyPanel' && node.callee?.object?.property?.name === 'Component' && node.callee?.property?.name === 'build') {
        return 'HeyPanel.Component.build';
    }
