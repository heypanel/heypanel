 ...
 * HeyPanel.Component.register('bar', {});
 * Module.register('foo', {});
 * HeyPanel.Module.register('bar', {});
...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            recommended: true,
            url: 'https://handbook.heypanel.com/Product/Product/Components/Admin/NewFeatures',
        },
    },
    create(context) {
        return {
            ...
            ExpressionStatement(node) {
                ...
                if (!isFeatureRegister && root?.object && root?.property && root?.object?.name === 'HeyPanel' && root.property.name === 'Component' && property === 'register') {
                    isFeatureRegister = true;
                }
                ...
                if (!isFeatureRegister && root?.object && root?.property && root?.object?.name === 'HeyPanel' && root.property.name === 'Module' && property === 'register') {
                    isFeatureRegister = true;
                }
                ...
                if (!isFeatureRegister && root?.callee?.object && root?.callee?.property && root?.callee?.object.name === 'HeyPanel' && root.callee.property.name === 'Service' && property === 'register') {
                    isFeatureRegister = true;
                }
