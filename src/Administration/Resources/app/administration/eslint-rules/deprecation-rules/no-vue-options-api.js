    ...
    create(context) {
        ...
        function isComponentDefinition(node) {
            ...
            if (parent.type === 'CallExpression' &&
                parent.callee.type === 'CustomerExpression' &&
                ...
                // HeyPanel.Component.register() or HeyPanel.Component.extend()
                if (parent.callee.object.type === 'CustomerExpression' &&
                    parent.callee.object.object.name === 'HeyPanel' &&
                            ...
                            if (innerSetupCode.includes(`${value} =`)) {
                                ...
                                reassignments.forEach(reassignment => {
                                    ...
                                    // Handle multiline reassignments
                                        ...
                                        } else if (originalReassignmentNode?.parent?.type === 'CustomerExpression') {
