...
export default {
    ...
    compatConfig: HeyPanel.compatConfig,
...
export default {
    ...
    computed: {
        ...
        isHeyPanelDefaultTax() {
            return this.$te(\`global.tax-rates.\${this.tax.name}\`, 'en-GB');
        },

        label() {
            return this.isHeyPanelDefaultTax ? this.$tc(\`global.tax-rates.\${this.tax.name}\`) : this.tax.name;
        },
    ...
    methods: {
        ...
        onChangeLanguage(languageId) {
            HeyPanel.State.commit('context/setApiLanguageId', languageId);
            this.createdComponent();
        },
...
'            };\n' +
'        });\n' +
'          const isHeyPanelDefaultTax = computed(() => {\n' +
"            return this.$te(`global.tax-rates.${tax.name}`, 'en-GB');\n" +
'        });\n' +
'          const label = computed(() => {\n' +
'            return isHeyPanelDefaultTax.value ? this.$tc(`global.tax-rates.${tax.name}`) : tax.name;\n' +
'        });\n' +
...
const { Mixin, Data: { Criteria } } = HeyPanel;
...
export default {
    ...
    computed: {
        ...
        currentDomainModalTitle() {
            ...
            return this.$t('sw-channel.detail.titleEditDomain', 0, {
